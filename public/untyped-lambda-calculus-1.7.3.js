...
(function($PS) {
  // Generated by purs version 0.13.3
  "use strict";
  $PS["UntypedLambda.Core"] = $PS["UntypedLambda.Core"] || {};
  var exports = $PS["UntypedLambda.Core"];
  var Data_Array = $PS["Data.Array"];
  ...
  var VVariable = (function () {
      ...
      VVariable.create = function (value0) {
          return new VVariable(value0);
      };
      return VVariable;
  })();
  var VLambdaAbstraction = (function () {
      function VLambdaAbstraction(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      VLambdaAbstraction.create = function (value0) {
          return function (value1) {
              return new VLambdaAbstraction(value0, value1);
          };
      };
      return VLambdaAbstraction;
  })();
  var VApplication = (function () {
      function VApplication(value0) {
          this.value0 = value0;
      };
      VApplication.create = function (value0) {
          return new VApplication(value0);
      };
      return VApplication;
  })();
  var VIdentApp = (function () {
      function VIdentApp(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      VIdentApp.create = function (value0) {
          return function (value1) {
              return new VIdentApp(value0, value1);
          };
      };
      return VIdentApp;
  })();
  var VAppApp = (function () {
      function VAppApp(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      VAppApp.create = function (value0) {
          return function (value1) {
              return new VAppApp(value0, value1);
          };
      };
      return VAppApp;
  })();
  ...
  var eqExpression = new Data_Eq.Eq(function (v) {
      return function (v1) {
          ...
          if (v instanceof LambdaAbstraction && v1 instanceof LambdaAbstraction) {
              return v.value0 === v1.value0 && Data_Eq.eq(eqExpression)(v.value1)(v1.value1);
          };
          if (v instanceof Application && v1 instanceof Application) {
              return Data_Eq.eq(eqExpression)(v.value0)(v1.value0) && Data_Eq.eq(eqExpression)(v.value1)(v1.value1);
          };
          return false;
      };
  });
  var displayExpression = new Data_Display.Display((function () {
      ...
      return function (v) {
          ...
          if (v instanceof LambdaAbstraction && v.value1 instanceof LambdaAbstraction) {
              return "\u03bb" + (v.value0 + (" " + Data_String_CodePoints.drop(1)(Data_Display.display(displayExpression)(v.value1))));
          };
          if (v instanceof LambdaAbstraction) {
              return "\u03bb" + (v.value0 + ("." + Data_Display.display(displayExpression)(v.value1)));
          };
          if (v instanceof Application) {
              return Data_String_Common.joinWith(" ")([ (function () {
                  ...
                  if (v.value0 instanceof LambdaAbstraction) {
                      return paren(Data_Display.display(displayExpression)(v.value0));
                  };
  ...
  var asExpression = function (v) {
      ...
      if (v instanceof VLambdaAbstraction) {
          return LambdaAbstraction.create(v.value0)(asExpression(v.value1));
      };
      if (v instanceof VApplication && v.value0 instanceof VIdentApp) {
          return Application.create(new Variable(v.value0.value0))(asExpression(v.value0.value1));
      };
      ...
      throw new Error("Failed pattern match at UntypedLambda.Core (line 165, column 1 - line 165, column 36): " + [ v.constructor.name ]);
  };
  ...
  var withEnvironment = function (env) {
      return function (expression) {
          var values = Data_Functor.map(Data_Functor.functorArray)(function (v) {
              return asExpression(v.value1);
          })(env);
          var names = Data_Functor.map(Data_Functor.functorArray)(function (v) {
              return v.value0;
          })(env);
          return Data_Foldable.foldl(Data_Foldable.foldableArray)(function (expr) {
              return function (value) {
                  return new Application(expr, value);
              };
          })(Data_Foldable.foldr(Data_Foldable.foldableArray)(function (name) {
              return function (expr) {
                  return new LambdaAbstraction(name, expr);
              };
  ...
  var alphaConversion = function (v) {
      return function (v1) {
          if (v1 instanceof Variable && v.value0 === v1.value0) {
              return v.value1;
          };
          var $$var = v1;
          ...
          if (v1 instanceof LambdaAbstraction && v.value0 === v1.value0) {
              return v1;
          };
          if (v1 instanceof LambdaAbstraction && Data_Foldable.notElem(Data_Foldable.foldableArray)(Data_Eq.eqString)(v1.value0)(freeVariables(v.value1))) {
              return LambdaAbstraction.create(v1.value0)(alphaConversion(v)(v1.value1));
          };
          if (v1 instanceof LambdaAbstraction) {
              var rename = function ($$var) {
                  return function (expr) {
                      var freeVars = freeVariables(expr);
                      var recur = function ($copy_n) {
                          var $tco_done = false;
                          var $tco_result;
                          function $tco_loop(n) {
                              var renamed = $$var + ("_" + Data_Int.toStringAs(Data_Int.decimal)(n));
                              var $132 = Data_Foldable.notElem(Data_Foldable.foldableArray)(Data_Eq.eqString)(renamed)(freeVars);
                              if ($132) {
                                  $tco_done = true;
                                  return renamed;
                              };
                      ...
                      var $133 = Data_Foldable.notElem(Data_Foldable.foldableArray)(Data_Eq.eqString)($$var)(freeVars);
                      if ($133) {
                          return $$var;
                      };
                      return recur(0);
              ...
              var newBody = alphaConversion(Substitution.create(v1.value0)(new Variable(newBound)))(v1.value1);
              var newLambda = new LambdaAbstraction(newBound, newBody);
  ...
  var betaReduction = function (v) {
      return function (arg) {
          ...
          return new Application(v, arg);
      };
  };
  var callByValue = function (v) {
      if (v instanceof Variable) {
          return new VVariable(v.value0);
      };
      if (v instanceof LambdaAbstraction) {
          return VLambdaAbstraction.create(v.value0)(callByValue(v.value1));
      };
      if (v instanceof Application) {
          return (function (v1) {
              if (v1 instanceof VVariable) {
                  return VApplication.create(VIdentApp.create(v1.value0)(callByValue(v.value1)));
              };
              if (v1 instanceof VLambdaAbstraction) {
                  return callByValue(Data_Function.on(betaReduction)(asExpression)(v1)(callByValue(v.value1)));
              };
              if (v1 instanceof VApplication) {
                  return VApplication.create(VAppApp.create(v1.value0)(callByValue(v.value1)));
              };
              throw new Error("Failed pattern match at UntypedLambda.Core (line 181, column 7 - line 184, column 75): " + [ v1.constructor.name ]);
          })(callByValue(v.value0));
      };
      throw new Error("Failed pattern match at UntypedLambda.Core (line 174, column 1 - line 174, column 35): " + [ v.constructor.name ]);
  };
...
(function($PS) {
  // Generated by purs version 0.13.3
  "use strict";
  $PS["UntypedLambda.Parser"] = $PS["UntypedLambda.Parser"] || {};
  var exports = $PS["UntypedLambda.Parser"];
  var Control_Alt = $PS["Control.Alt"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Apply = $PS["Control.Apply"];
  var Control_Bind = $PS["Control.Bind"];
  ...
  var expression = (function () {
      var variable = Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(UntypedLambda_Core.Variable.create)(identifier);
      var lambdaAbstraction = function (expr) {
              ...
              return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(identifier)(function (v1) {
                  return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(spaces1(Data_Identity.monadIdentity))(Text_Parsing_Parser_Combinators.sepEndBy(Data_Identity.monadIdentity)(identifier)(spaces1(Data_Identity.monadIdentity))))(Control_Applicative.pure(Text_Parsing_Parser.applicativeParserT(Data_Identity.monadIdentity))(Data_List_Types.Nil.value)))(function (v2) {
                      return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(Control_Apply.applyFirst(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(spaces(Data_Identity.monadIdentity))(Text_Parsing_Parser_String.string(Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)(".")))(spaces(Data_Identity.monadIdentity)))(function (v3) {
                          return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(expr)(function (v4) {
                              return Control_Applicative.pure(Text_Parsing_Parser.applicativeParserT(Data_Identity.monadIdentity))(Data_Foldable.foldr(Data_List_Types.foldableList)(UntypedLambda_Core.LambdaAbstraction.create)(v4)(new Data_List_Types.Cons(v1, v2)));
                          });
                      });
                  });
              });
      ...
      var term = function (expr) {
          return Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(parens(Data_Identity.monadIdentity)(expr))(variable))(lambdaAbstraction(expr));
      };
      var _expression = Control_Lazy.fix(Text_Parsing_Parser.lazyParserT)(function (expr) {
          return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(term(expr))(function (v) {
              return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(spaces(Data_Identity.monadIdentity))(Text_Parsing_Parser_Combinators.sepEndBy(Data_Identity.monadIdentity)(term(expr))(spaces1(Data_Identity.monadIdentity))))(Control_Applicative.pure(Text_Parsing_Parser.applicativeParserT(Data_Identity.monadIdentity))(Data_List_Types.Nil.value)))(function (v1) {
                  return Control_Applicative.pure(Text_Parsing_Parser.applicativeParserT(Data_Identity.monadIdentity))((function () {
                      var $15 = Data_Eq.eq(Data_List_Types.eqList(UntypedLambda_Core.eqExpression))(v1)(Data_List_Types.Nil.value);
                      if ($15) {
                          return v;
                      };
                      return Data_Foldable.foldl(Data_List_Types.foldableList)(UntypedLambda_Core.Application.create)(v)(v1);
                  })());
              });
          });
      });
      return Control_Apply.applyFirst(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(spaces(Data_Identity.monadIdentity))(_expression))(Text_Parsing_Parser_String.eof(Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity));
  })();
      ...
      return function ($copy_v) {
          ...
          function $tco_loop(input, v) {
              if (v.inputMode instanceof Multiline) {
                  var endMultiline = Data_Functor.voidRight(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(EndMultiline.value)(Control_Apply.applyFirst(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Control_Apply.applyFirst(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(UntypedLambda_Parser.spaces(Data_Identity.monadIdentity))(Text_Parsing_Parser_String.string(Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)(".end")))(UntypedLambda_Parser.spaces(Data_Identity.monadIdentity)))(Text_Parsing_Parser_String.eof(Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)));
              ...
              var endMultiline = Data_Functor.voidRight(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(EndMultiline.value)(Control_Apply.applyFirst(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Control_Apply.applyFirst(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(UntypedLambda_Parser.spaces(Data_Identity.monadIdentity))(Text_Parsing_Parser_String.string(Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)(".end")))(UntypedLambda_Parser.spaces(Data_Identity.monadIdentity)))(Text_Parsing_Parser_String.eof(Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)));
              var define = Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(UntypedLambda_Parser.spaces(Data_Identity.monadIdentity))(function (v1) {
                  return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(UntypedLambda_Parser.identifier)(function (v2) {
                      return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(Control_Apply.applyFirst(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(UntypedLambda_Parser.spaces(Data_Identity.monadIdentity))(Text_Parsing_Parser_String.string(Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)("=")))(UntypedLambda_Parser.spaces(Data_Identity.monadIdentity)))(function (v3) {
                          return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(UntypedLambda_Parser.expression)(function (v4) {
                              return Control_Applicative.pure(Text_Parsing_Parser.applicativeParserT(Data_Identity.monadIdentity))(new Definition(v2, v4));
                          });
                      });
                  });
              });
              var _expression = Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(Expression.create)(UntypedLambda_Parser.expression);
              ...
              if (v1 instanceof Data_Either.Right && v1.value0 instanceof Definition) {
                  var value = UntypedLambda_Core.callByValue(UntypedLambda_Core.withEnvironment(v.env)(v1.value0.value1));
                  $tco_done = true;
                  return REPL({
                      env: Data_Array.snoc(v.env)(new Data_Tuple.Tuple(v1.value0.value0, value)),
                      history: Data_Array.snoc(v.history)({
                          input: input,
                          output: Data_Maybe.Just.create(Data_Display.display(UntypedLambda_Core.displayExpression)(UntypedLambda_Core.asExpression(value)))
                      }),
                      inputMode: v.inputMode,
                      inputPool: v.inputPool
                  });
              };
              if (v1 instanceof Data_Either.Right && v1.value0 instanceof Expression) {
                  $tco_done = true;
                  return REPL({
                      env: v.env,
                      history: Data_Array.snoc(v.history)({
                          input: input,
                          output: Data_Maybe.Just.create(Data_Display.display(UntypedLambda_Core.displayExpression)(UntypedLambda_Core.asExpression(UntypedLambda_Core.callByValue(UntypedLambda_Core.withEnvironment(v.env)(v1.value0.value0)))))
                      }),
                      inputMode: v.inputMode,
                      inputPool: v.inputPool
                  });
...
(function($PS) {
  ...
  var CalculateTextAreaRows = (function () {
      function CalculateTextAreaRows(value0) {
          this.value0 = value0;
      };
      CalculateTextAreaRows.create = function (value0) {
          return new CalculateTextAreaRows(value0);
      };
  ...
  var getString = function (v) {
      ...
      throw new Error("Failed pattern match at Editor (line 91, column 1 - line 91, column 26): " + [ v.constructor.name ]);
  };
  var main = (function () {
      var render = function (state) {
          var inputLine = function (classes) {
              return function (mode) {
                  var prompt = function (withPrompt) {
                      return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ "flex", "justify-end" ])((function () {
                          if (withPrompt instanceof WithPrompt) {
                              return [  ];
                          };
                          if (withPrompt instanceof WithoutPrompt) {
                              return [ "invisible" ];
                          };
                          throw new Error("Failed pattern match at Editor (line 632, column 18 - line 634, column 64): " + [ withPrompt.constructor.name ]);
                      })())) ])([ Halogen_HTML_Elements.span([ Halogen_HTML_Properties.classes([ "mr-1" ]) ])([ Halogen_HTML_Core.text(">") ]) ]);
                  };
                  if (mode instanceof Dummy) {
                      return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ "flex", "font-mono" ])(classes)) ])(Data_Array.cons(prompt(WithPrompt.value))([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "w-full", "bg-gray-800" ]) ])([ mode.value0 ]) ]));
                  };
                  if (mode instanceof TextArea) {
                      return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ "flex", "font-mono" ])(classes)) ])(Data_Array.cons(prompt(mode.value0))([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "flex", "relative", "w-full" ]) ])([ Halogen_HTML_Elements.textarea([ Halogen_HTML_Properties.id_(getString(TextAreaId.value)), Halogen_HTML_Properties.classes([ "w-full", "apperance-none", "focus:outline-none", "bg-gray-800", "resize-none", "overflow-y-hidden", "z-10", "break-all" ]), Halogen_HTML_Properties.rows(state.textAreaRows), Halogen_HTML_Properties.autofocus(true), Halogen_HTML_Properties.value(state.input), Halogen_HTML_Events.onKeyDown(function ($157) {
                          return Data_Maybe.Just.create(KeyDown.create($157));
                      }), Halogen_HTML_Events.onKeyUp(function ($158) {
                          return Data_Maybe.Just.create(KeyUp.create($158));
                      }), Halogen_HTML_Events.onValueInput(function ($159) {
                          return Data_Maybe.Just.create(Input.create($159));
                      }) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.id_(getString(BehindTextAreaId.value)), Halogen_HTML_Properties.classes([ "absolute", "w-full", "break-all", "bg-gray-900", "text-gray-900", "whitespace-pre-wrap" ]) ])([ Halogen_HTML_Core.text(state.input) ]) ]) ]));
                  };
                  throw new Error("Failed pattern match at Editor (line 578, column 30 - line 626, column 14): " + [ mode.constructor.name ]);
              };
          };
          var repl = Data_Newtype.unwrap(UntypedLambda_REPL.newtypeREPL)(state.repl);
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "min-w-full", "min-h-full", "bg-gray-900", "text-white", "text-base", "font-sans" ]), Halogen_HTML_Events.onClick(function (me) {
              var e = Web_UIEvent_MouseEvent.toEvent(me);
              return Data_Maybe.Just.create(new Composition([ new PreventDefault(e), new StopPropagation(e), HiddenSelectOrCopyPopup.value ]));
          }) ])([ Halogen_HTML_Elements.header([ Halogen_HTML_Properties.classes([ "flex", "justify-between", "py-4" ]) ])([ Halogen_HTML_Elements.h1([ Halogen_HTML_Properties.classes([ "mx-6", "text-3xl" ]) ])([ Halogen_HTML_Elements.span([ Halogen_HTML_Properties.classes([ "inline-block", "w-12", "h-12", "rounded-full", "bg-indigo-800", "align-middle", "text-center", "font-black", "font-mono" ]) ])([ Halogen_HTML_Elements.span([ Halogen_HTML_Properties.classes([ "inline-block", "pt-1" ]) ])([ Halogen_HTML_Core.text("\u03bb") ]) ]) ]), Halogen_HTML_Elements.nav([ Halogen_HTML_Properties.classes([ "mx-2" ]) ])([ Halogen_HTML_Elements.ul([ Halogen_HTML_Properties.classes([ "flex", "justify-end" ]) ])([ Halogen_HTML_Elements.li_([ Halogen_HTML_Elements.a([ Halogen_HTML_Properties.target("_blank"), Halogen_HTML_Properties.href("https://github.com/utatatata/untyped-lambda-calculus") ])([ Halogen_HTML_Core.text("GitHub") ]) ]) ]) ]) ]), Halogen_HTML_Elements.main([ Halogen_HTML_Properties.classes([ "mx-4", "w-auto", "border-2", "border-gray-800", "rounded", "p-2" ]) ])([ Halogen_HTML_Elements.ul([ Halogen_HTML_Properties.classes([ "flex", "mb-5", "text-gray-400" ]) ])((function () {
              ...
              if (state.popupState instanceof Display) {
                  return [ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "absolute", "flex", "flex-col", "z-20" ]), Halogen_HTML_CSS.style(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.left(CSS_Size.px(Data_Int.toNumber(state.popupState.value1.x - 30 | 0))))(function () {
              ...
              throw new Error("Failed pattern match at Editor (line 377, column 21 - line 447, column 26): " + [ state.popupState.constructor.name ]);
              ...
              return Halogen_HTML_Elements.div_(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ inputLine([  ])(Dummy.create(Halogen_HTML_Elements.span([ Halogen_HTML_Properties.classes([ "inline-block", "w-full", "break-all", "whitespace-pre-wrap" ]), Halogen_HTML_Events.onClick(function (me) {
                  ...
                  throw new Error("Failed pattern match at Editor (line 468, column 32 - line 480, column 46): " + [ v.output.constructor.name ]);
              })()));
              ...
              if (repl.inputMode instanceof UntypedLambda_REPL.Multiline) {
                  var $58 = Data_Eq.eq(Data_Eq.eqArray(Data_Eq.eqString))(repl.inputPool)([  ]);
                  if ($58) {
                      return [ "hidden" ];
                  };
                  return [  ];
              };
              throw new Error("Failed pattern match at Editor (line 483, column 25 - line 489, column 33): " + [ repl.inputMode.constructor.name ]);
          ...
          })(repl.inputPool)))), inputLine([  ])(TextArea.create((function () {
              if (repl.inputMode instanceof UntypedLambda_REPL.Singleline) {
                  return WithPrompt.value;
              };
              if (repl.inputMode instanceof UntypedLambda_REPL.Multiline) {
                  var $60 = Data_Eq.eq(Data_Eq.eqArray(Data_Eq.eqString))(repl.inputPool)([  ]);
                  if ($60) {
                      return WithPrompt.value;
                  };
                  return WithoutPrompt.value;
              };
              throw new Error("Failed pattern match at Editor (line 498, column 25 - line 504, column 44): " + [ repl.inputMode.constructor.name ]);
          })())) ])), Halogen_HTML_Elements.section([ Halogen_HTML_Properties.classes((function () {
              if (state.tab instanceof Environment) {
                  return [  ];
              };
          ...
          var copyListener = function (str) {
              return function (event) {
                  return function __do() {
                      ...
                      throw new Error("Failed pattern match at Editor (line 245, column 7 - line 249, column 34): " + [ v1.constructor.name ]);
                  };
              };
          };
          ...
          return function (v) {
              ...
              if (v instanceof Input) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                      ...
                      $74.input = v.value0;
                      $74.inputMode = Inputting.value;
                      return $74;
                  }))(function () {
                      return handleAction(new CalculateTextAreaRows(v.value0));
                  });
              };
                  ...
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(handleAction(HiddenSelectOrCopyPopup.value))(function () {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                          return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                              ...
                              $79.input = "";
                              $79.textAreaRows = 1;
                              $79.inputMode = Inputting.value;
                              $79.repl = UntypedLambda_REPL["eval"](v1.input)(v1.repl);
                              return $79;
                          });
                      });
                  });
              ...
              if (v instanceof CalculateTextAreaRows) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(function __do() {
                      ...
                      if (v1 instanceof Data_Maybe.Just) {
                          ...
                          var last = Data_String_CodeUnits.takeRight(1)(v.value0);
                          var $92 = last === "" || (last === "\x0a" || last === "\x0d");
                          if ($92) {
                              return Data_Maybe.Just.create(rows + 1 | 0);
                          };
                          return new Data_Maybe.Just(rows);
                      };
                      throw new Error("Failed pattern match at Editor (line 161, column 15 - line 176, column 20): " + [ v1.constructor.name ]);
                  }))(function (v1) {
                      if (v1 instanceof Data_Maybe.Nothing) {
                          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
                      };
                      if (v1 instanceof Data_Maybe.Just) {
                          return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                              ...
                              $96.textAreaRows = v1.value0;
                              return $96;
                          });
                      };
                      throw new Error("Failed pattern match at Editor (line 177, column 7 - line 179, column 57): " + [ v1.constructor.name ]);
                  });
              };
                  ...
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(handleAction(HiddenSelectOrCopyPopup.value))(function () {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                          var n = (function () {
                              ...
                              throw new Error("Failed pattern match at Editor (line 184, column 15 - line 186, column 52): " + [ v1.inputMode.constructor.name ]);
                          })();
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v2) {
                              var v3 = Data_Array.index(v2.repl.history)((Data_Array.length(v2.repl.history) - n | 0) - 1 | 0);
                              if (v3 instanceof Data_Maybe.Nothing) {
                                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
                              };
                              if (v3 instanceof Data_Maybe.Just) {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v4) {
                                      ...
                                      $106.input = v3.value0.input;
                                      $106.inputMode = new SelectingHistory(n);
                                      return $106;
                                  }))(function () {
                                      return handleAction(new CalculateTextAreaRows(v3.value0.input));
                                  });
                              };
                              throw new Error("Failed pattern match at Editor (line 190, column 13 - line 195, column 59): " + [ v3.constructor.name ]);
                          });
                      });
                  });
              };
                      ...
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                          ...
                          if (v1.inputMode instanceof SelectingHistory && v1.inputMode.value0 === 0) {
                              return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                                  ...
                                  $117.input = "";
                                  $117.textAreaRows = 1;
                                  $117.inputMode = Inputting.value;
                                  return $117;
                              });
                          };
                          if (v1.inputMode instanceof SelectingHistory) {
                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v2) {
                                  var v3 = Data_Array.index(v2.repl.history)(Data_Array.length(v2.repl.history) - v1.inputMode.value0 | 0);
                                  if (v3 instanceof Data_Maybe.Nothing) {
                                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
                                  };
                                  if (v3 instanceof Data_Maybe.Just) {
                                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v4) {
                                          ...
                                          $123.input = v3.value0.input;
                                          $123.inputMode = SelectingHistory.create(v1.inputMode.value0 - 1 | 0);
                                          return $123;
                                      }))(function () {
                                          return handleAction(new CalculateTextAreaRows(v3.value0.input));
                                      });
                                  };
                                  throw new Error("Failed pattern match at Editor (line 205, column 11 - line 209, column 57): " + [ v3.constructor.name ]);
                              });
                          };
                          throw new Error("Failed pattern match at Editor (line 200, column 7 - line 209, column 57): " + [ v1.inputMode.constructor.name ]);
                      });
                  });
              };
              ...
              if (v instanceof FocusById) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(handleAction(HiddenSelectOrCopyPopup.value))(function () {
                      return Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(function __do() {
                          ...
                          throw new Error("Failed pattern match at Editor (line 218, column 13 - line 220, column 35): " + [ v2.constructor.name ]);
                      });
                  });
              };
              if (v instanceof DisplaySelectOrCopyPopup) {
                  return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                      ...
                      $141.popupState = new Display(v.value0, {
              ...
              throw new Error("Failed pattern match at Editor (line 128, column 18 - line 235, column 22): " + [ v.constructor.name ]);
          };
      })();
  ...
  exports["KeyDown"] = KeyDown;
  exports["KeyUp"] = KeyUp;
  exports["CalculateTextAreaRows"] = CalculateTextAreaRows;
