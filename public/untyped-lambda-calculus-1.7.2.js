  ...
  var main = (function () {
      var render = function (state) {
              ...
              return function (mode) {
                  var prompt = function (withPrompt) {
                      return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ "flex", "justify-end" ])((function () {
                          ...
                          throw new Error("Failed pattern match at Editor (line 630, column 18 - line 632, column 64): " + [ withPrompt.constructor.name ]);
                  ...
                  throw new Error("Failed pattern match at Editor (line 576, column 30 - line 624, column 14): " + [ mode.constructor.name ]);
              };
          };
          ...
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "min-w-full", "min-h-full", "bg-gray-900", "text-white", "text-base", "font-sans" ]), Halogen_HTML_Events.onClick(function (me) {
              ...
              return [ "hidden" ];
          })()) ])([ Halogen_HTML_Elements.h2([ Halogen_HTML_Properties.classes([ "text-xl", "mb-4" ]) ])([ Halogen_HTML_Core.text("REPL for The Untyped \u03bb Calculus") ]), Halogen_HTML_Elements.section([ Halogen_HTML_Properties.classes([ "mb-8" ]) ])([ Halogen_HTML_Elements.h3([ Halogen_HTML_Properties.classes([ "text-lg", "mb-2" ]) ])([ Halogen_HTML_Core.text("Interpreter Options") ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "ml-2", "break-words" ]) ])([ Halogen_HTML_Core.text("Type `.help` in REPL for help.") ]) ]), Halogen_HTML_Elements.section([ Halogen_HTML_Properties.classes([ "mb-8" ]) ])([ Halogen_HTML_Elements.h3([ Halogen_HTML_Properties.classes([ "text-lg", "mb-2" ]) ])([ Halogen_HTML_Core.text("Syntax of \u03bb expression") ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "flex", "ml-4", "mt-2", "mb-4" ]) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "flex", "flex-col", "mr-2" ]) ])([ Halogen_HTML_Elements.div([  ])([ Halogen_HTML_Core.text("<expression> ::=") ]), Halogen_HTML_Elements.div([  ])([ Halogen_HTML_Core.text("<expression> ::=") ]), Halogen_HTML_Elements.div([  ])([ Halogen_HTML_Core.text("<expression> ::=") ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "flex", "flex-col" ]) ])([ Halogen_HTML_Elements.div([  ])([ Halogen_HTML_Core.text("<variable>") ]), Halogen_HTML_Elements.div([  ])([ Halogen_HTML_Core.text("<lambda abstraction>") ]), Halogen_HTML_Elements.div([  ])([ Halogen_HTML_Core.text("<application>") ]) ]) ]), Halogen_HTML_Elements.section([ Halogen_HTML_Properties.classes([ "mb-4" ]) ])([ Halogen_HTML_Elements.h4([ Halogen_HTML_Properties.classes([ "mb-2" ]) ])([ Halogen_HTML_Core.text("1. Variables") ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "ml-4", "mt-2", "mb-4" ]) ])([ Halogen_HTML_Core.text("<variable> ::= <identifier>") ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "ml-2", "break-words" ]) ])([ Halogen_HTML_Elements.p([  ])([ Halogen_HTML_Core.text("<identifier> consists of alphabets, digits, ASCII characters except '\u03bb', and symbols '!', '@', '#', '$', '%', '^', '&', '*', '-', '_', '+', '|', '<', '>', '/', '?'.") ]) ]) ]), Halogen_HTML_Elements.section([ Halogen_HTML_Properties.classes([ "mb-4" ]) ])([ Halogen_HTML_Elements.h4([ Halogen_HTML_Properties.classes([ "mb-2" ]) ])([ Halogen_HTML_Core.text("2. Lambda Abstractions") ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "ml-4", "mt-2", "mb-4" ]) ])([ Halogen_HTML_Elements.div([  ])([ Halogen_HTML_Core.text("<lambda abstraction> :: = (\u03bb<identifier>.<expression>)") ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "ml-2", "break-words" ]) ])([ Halogen_HTML_Elements.p([  ])([ Halogen_HTML_Core.text("Lambda abstractions are right-associative.") ]), Halogen_HTML_Elements.p([  ])([ Halogen_HTML_Core.text("`(\u03bbx.\u03bby.M)` is equivalent to `(\u03bbx.(\u03bby.M))`.") ]), Halogen_HTML_Elements.p([  ])([ Halogen_HTML_Core.text("`(\u03bbx y.M)` is abbreviation of `(\u03bbx.(\u03bby.M))`.") ]) ]) ]), Halogen_HTML_Elements.section([ Halogen_HTML_Properties.classes([ "mb-4" ]) ])([ Halogen_HTML_Elements.h4([ Halogen_HTML_Properties.classes([ "mb-2" ]) ])([ Halogen_HTML_Core.text("3. Applications") ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "ml-4", "mt-2", "mb-4" ]) ])([ Halogen_HTML_Elements.div([  ])([ Halogen_HTML_Core.text("<application> ::= (<expression> <expression>)") ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "ml-2", "break-words" ]) ])([ Halogen_HTML_Elements.p([  ])([ Halogen_HTML_Core.text("Applications are left-associative.") ]), Halogen_HTML_Elements.p([  ])([ Halogen_HTML_Core.text("`(M N L)` is equivalent to `((M N) L)`.") ]) ]) ]) ]) ]) ]) ]);
      };
