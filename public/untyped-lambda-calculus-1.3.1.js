...
(function($PS) {
  // Generated by purs version 0.13.3
  "use strict";
  $PS["UntypedLambda"] = $PS["UntypedLambda"] || {};
  var exports = $PS["UntypedLambda"];
  var UntypedLambda_Core = $PS["UntypedLambda.Core"];                
  var display = function ($0) {
      return UntypedLambda_Core.display(UntypedLambda_Core.asExpression($0));
  };
  exports["display"] = display;
})(PS);
(function($PS) {
...
(function($PS) {
  ...
  var define = Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(UntypedLambda_Parser.identifier)(function (v) {
      return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(Control_Apply.applyFirst(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(UntypedLambda_Parser.spaces(Data_Identity.monadIdentity))(Text_Parsing_Parser_String.string(Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)("=")))(UntypedLambda_Parser.spaces(Data_Identity.monadIdentity)))(function (v1) {
          return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(UntypedLambda_Parser.expression)(function (v2) {
  ...
  var $$eval = function (env) {
      return function (str) {
          var v = Text_Parsing_Parser.runParser(str)(define);
          if (v instanceof Data_Either.Right) {
              return Control_Applicative.pure(Data_Either.applicativeEither)((function () {
                  var value = UntypedLambda_Core.callByValue(UntypedLambda_Core.withEnvironment(env)(v.value0.value1));
                  return Data_Tuple.Tuple.create(value)(Data_Array.cons(Data_Tuple.Tuple.create(v.value0.value0)(value))(env));
              })());
          };
          if (v instanceof Data_Either.Left) {
              return Data_Functor.mapFlipped(Data_Either.functorEither)(Data_Functor.mapFlipped(Data_Either.functorEither)(Text_Parsing_Parser.runParser(str)(UntypedLambda_Parser.expression))((function () {
                  var $11 = UntypedLambda_Core.withEnvironment(env);
                  return function ($12) {
                      return UntypedLambda_Core.callByValue($11($12));
                  };
              })()))(Data_Function.flip(Data_Tuple.Tuple.create)(env));
          };
          throw new Error("Failed pattern match at UntypedLambda.Repl (line 22, column 16 - line 24, column 100): " + [ v.constructor.name ]);
      };
  };
  exports["eval"] = $$eval;
})(PS);
...
(function($PS) {
  ...
  var Text_Parsing_Parser = $PS["Text.Parsing.Parser"];
  var UntypedLambda = $PS["UntypedLambda"];
  var UntypedLambda_Core = $PS["UntypedLambda.Core"];
  ...
  var HiddenReplInput = (function () {
      function HiddenReplInput() {

      };
      HiddenReplInput.value = new HiddenReplInput();
      return HiddenReplInput;
  })();
  var InputLine = (function () {
      function InputLine() {

      };
      InputLine.value = new InputLine();
      return InputLine;
  })();
  ...
  var MoveCursorLeft = (function () {
      ...
      MoveCursorLeft.value = new MoveCursorLeft();
  ...
  var MoveCursorRight = (function () {
      ...
      MoveCursorRight.value = new MoveCursorRight();
  ...
  var toString = function (v) {
      if (v instanceof HiddenReplInput) {
          return "hidden-repl-input";
      };
      if (v instanceof InputLine) {
          return "input-line";
      };
      throw new Error("Failed pattern match at Editor (line 79, column 1 - line 79, column 25): " + [ v.constructor.name ]);
  };
  var main = (function () {
      var render = function (state) {
          return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.header([ Halogen_HTML_Properties.classes([ "flex", "justify-between", "my-4" ]) ])([ Halogen_HTML_Elements.h1([ Halogen_HTML_Properties.classes([ "mx-6", "text-3xl" ]) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "w-12", "h-12", "rounded-full", "bg-indigo-800", "align-middle", "text-center", "font-black" ]) ])([ Halogen_HTML_Core.text("\u03bb") ]) ]), Halogen_HTML_Elements.nav([ Halogen_HTML_Properties.classes([ "mx-2" ]) ])([ Halogen_HTML_Elements.ul([ Halogen_HTML_Properties.classes([ "flex justify-end" ]) ])([ Halogen_HTML_Elements.li_([ Halogen_HTML_Elements.a([ Halogen_HTML_Properties.target("_blank"), Halogen_HTML_Properties.href("https://github.com/utatatata/untyped-lambda-calculus") ])([ Halogen_HTML_Core.text("GitHub") ]) ]) ]) ]) ]), Halogen_HTML_Elements.main([ Halogen_HTML_Properties.classes([ "mx-4", "w-auto" ]) ])([ Halogen_HTML_Elements.section_([ Halogen_HTML_Elements.h2_([ Halogen_HTML_Core.text("REPL") ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "flex", "flex-col-reverse" ]) ])(Data_Functor.map(Data_Functor.functorArray)(function (v) {
              ...
              return Data_Maybe.Just.create(KeyDown.create($184));
          }), Halogen_HTML_Events.onClick(Data_Function["const"](Data_Maybe.Just.create(new Composition([ new FocusById(HiddenReplInput.value), MoveCursor.create(Data_String_CodePoints.length(state.input)) ])))) ])([ Halogen_HTML_Elements.div((function () {
              if (state.cursorPos instanceof Data_Maybe.Nothing) {
                  return [ Halogen_HTML_Properties.classes([ "pointer-events-none", "absolute", "invisible" ]) ];
              };
              if (state.cursorPos instanceof Data_Maybe.Just) {
                  return [ Halogen_HTML_Properties.classes([ "pointer-events-none", "absolute" ]), Halogen_HTML_CSS.style(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.left(CSS_Size.px(state.cursorPos.value0.left)))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.top(CSS_Size.px(state.cursorPos.value0.top)))(function () {
                          return CSS_Geometry.marginLeft(CSS_Size.rem(-0.2));
                      });
                  })) ];
              };
              throw new Error("Failed pattern match at Editor (line 308, column 29 - line 317, column 34): " + [ state.cursorPos.constructor.name ]);
          })())([ Halogen_HTML_Elements.span([  ])([ Halogen_HTML_Core.text("|") ]) ]), Halogen_HTML_Elements.div([  ])([ Halogen_HTML_Elements.input([ Halogen_HTML_Properties.id_(toString(HiddenReplInput.value)), Halogen_HTML_Properties.type_(Halogen_HTML_Core.isPropInputType)(DOM_HTML_Indexed_InputType.InputText.value), Halogen_HTML_Properties.autofocus(true), Halogen_HTML_Properties.classes([ "absolute", "w-0", "h-0", "appearance-none", "bg-gray-900", "focus:outline-none", "text-gray-900" ]), Halogen_HTML_Events.onBlur(Data_Function["const"](Data_Maybe.Just.create(HideCursor.value))) ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.id_(toString(InputLine.value)), Halogen_HTML_Properties.classes([ "flex", "flex-wrap" ]) ])(Data_Array.snoc(Data_Array.mapWithIndex(function (i) {
              return function (c) {
                  return Halogen_HTML_Elements.span([ Halogen_HTML_Properties.class_("w-2"), Halogen_HTML_Events.onClick(function (e) {
                      return Data_Maybe.Just.create(new Composition([ new FocusById(HiddenReplInput.value), StopPropagation.create(Web_UIEvent_MouseEvent.toEvent(e)), MoveCursor.create(i + 1 | 0) ]));
                  }) ])([ Halogen_HTML_Core.text(Data_String_CodeUnits.singleton(c)) ]);
              };
          })(Data_String_CodeUnits.toCharArray(state.input)))(Halogen_HTML_Elements.span([ Halogen_HTML_Properties.classes([ "w-0" ]) ])([  ]))) ]) ]) ]) ]) ]);
      };
      var initialState = function (v) {
          return {
              input: "",
              inputMode: Inputting.value,
              cursorPos: new Data_Maybe.Just({
                  col: 0,
                  left: 0.0,
                  top: 0.0
              }),
      ...
      var handleAction = (function () {
          var byId = function (id) {
              return function __do() {
                  ...
                  return Web_DOM_NonElementParentNode.getElementById(toString(id))(Web_HTML_HTMLDocument.toNonElementParentNode(v))();
              };
          };
          return function (v) {
              ...
              if (v instanceof FocusById) {
                  return Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(function __do() {
                      ...
                      var v2 = Control_Bind.bind(Data_Maybe.bindMaybe)(v1)(Web_HTML_HTMLElement.fromElement);
                      if (v2 instanceof Data_Maybe.Nothing) {
                          return Data_Unit.unit;
                      };
                      if (v2 instanceof Data_Maybe.Just) {
                      ...
                      throw new Error("Failed pattern match at Editor (line 119, column 13 - line 123, column 34): " + [ v2.constructor.name ]);
                  });
              };
              if (v instanceof HistoryUp) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                      var n = (function () {
                          ...
                          throw new Error("Failed pattern match at Editor (line 128, column 15 - line 130, column 52): " + [ v1.inputMode.constructor.name ]);
                      })();
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v2) {
                          ...
                          if (v3 instanceof Data_Maybe.Just) {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v4) {
                                  ...
                                  $66.inputMode = new SelectingHistory(n);
                                  $66.input = v3.value0.input;
                                  return $66;
                              }))(function () {
                                  return handleAction(MoveCursor.create(Data_String_CodePoints.length(v3.value0.input)));
                              });
                          };
                          throw new Error("Failed pattern match at Editor (line 134, column 13 - line 142, column 59): " + [ v3.constructor.name ]);
                      });
                  });
              };
                  ...
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                      ...
                      if (v1.inputMode instanceof SelectingHistory && v1.inputMode.value0 === 0) {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                              ...
                              $76.inputMode = Inputting.value;
                              $76.input = "";
                              return $76;
                          }))(function () {
                              return handleAction(new MoveCursor(0));
                          });
                      };
                      if (v1.inputMode instanceof SelectingHistory) {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v2) {
                              ...
                              if (v3 instanceof Data_Maybe.Just) {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v4) {
                                      ...
                                      $82.inputMode = SelectingHistory.create(v1.inputMode.value0 - 1 | 0);
                                      $82.input = v3.value0.input;
                                      return $82;
                                  }))(function () {
                                      return handleAction(MoveCursor.create(Data_String_CodePoints.length(v3.value0.input)));
                                  });
                              };
                              throw new Error("Failed pattern match at Editor (line 157, column 11 - line 165, column 57): " + [ v3.constructor.name ]);
                          });
                      };
                      throw new Error("Failed pattern match at Editor (line 146, column 7 - line 165, column 57): " + [ v1.inputMode.constructor.name ]);
                  });
              };
              if (v instanceof HideCursor) {
                  return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                      ...
                      $91.cursorPos = Data_Maybe.Nothing.value;
                      return $91;
                  });
              };
              if (v instanceof MoveCursor) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                      var col = Data_Ord.max(Data_Ord.ordInt)(0)(Data_Ord.min(Data_Ord.ordInt)(Data_String_CodePoints.length(v1.input))(v.value0));
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(function __do() {
                          var v2 = byId(InputLine.value)();
                          if (v2 instanceof Data_Maybe.Nothing) {
                              return Data_Maybe.Nothing.value;
                          };
                          if (v2 instanceof Data_Maybe.Just) {
                              var v3 = Control_Bind.bind(Effect.bindEffect)(Web_DOM_Node.childNodes(Web_DOM_Element.toNode(v2.value0)))(Web_DOM_NodeList.toArray)();
                              var v4 = Control_Bind.bind(Data_Maybe.bindMaybe)(Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Array.index(v3)(col))(Web_DOM_Element.fromNode))(Web_HTML_HTMLElement.fromElement);
                              if (v4 instanceof Data_Maybe.Nothing) {
                                  return Data_Maybe.Nothing.value;
                              };
                              if (v4 instanceof Data_Maybe.Just) {
                                  return Data_Functor.map(Effect.functorEffect)(Data_Maybe.Just.create)(Control_Apply.apply(Effect.applyEffect)(Data_Functor.map(Effect.functorEffect)(function (v5) {
                                      return function (v6) {
                                          return {
                                              left: v5,
                                              top: v6
                                  ...
                                  })(Web_HTML_HTMLElement.offsetLeft(v4.value0)))(Web_HTML_HTMLElement.offsetTop(v4.value0)))();
                              };
                              throw new Error("Failed pattern match at Editor (line 181, column 25 - line 183, column 141): " + [ v4.constructor.name ]);
                          };
                          throw new Error("Failed pattern match at Editor (line 177, column 21 - line 183, column 141): " + [ v2.constructor.name ]);
                      }))(function (v2) {
                          if (v2 instanceof Data_Maybe.Nothing) {
                              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
                          };
                          if (v2 instanceof Data_Maybe.Just) {
                              return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                                  ...
                                  $103.cursorPos = new Data_Maybe.Just({
                                      col: col,
                                      left: v2.value0.left,
                                      top: v2.value0.top
                                  });
                          ...
                          throw new Error("Failed pattern match at Editor (line 185, column 13 - line 188, column 104): " + [ v2.constructor.name ]);
                      });
                  });
              };
              if (v instanceof MoveCursorLeft) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                      if (v1.cursorPos instanceof Data_Maybe.Nothing) {
                          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
                      };
                      if (v1.cursorPos instanceof Data_Maybe.Just) {
                          return handleAction(MoveCursor.create(v1.cursorPos.value0.col - 1 | 0));
                      };
                      throw new Error("Failed pattern match at Editor (line 192, column 7 - line 194, column 77): " + [ v1.cursorPos.constructor.name ]);
                  });
              };
              if (v instanceof MoveCursorRight) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                      ...
                      throw new Error("Failed pattern match at Editor (line 197, column 7 - line 199, column 77): " + [ v1.cursorPos.constructor.name ]);
                  });
              };
              ...
              if (v instanceof Insert) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                      ...
                      if (v1.cursorPos instanceof Data_Maybe.Just) {
                          var v2 = Data_String_CodeUnits.splitAt(v1.cursorPos.value0.col)(v1.input);
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                              ...
                              $134.input = v2.before + (Data_String_CodeUnits.singleton(v.value0) + v2.after);
                              $134.inputMode = Inputting.value;
                              return $134;
                          }))(function () {
                              return handleAction(MoveCursor.create(v1.cursorPos.value0.col + 1 | 0));
                          });
                      };
                      throw new Error("Failed pattern match at Editor (line 214, column 7 - line 223, column 12): " + [ v1.cursorPos.constructor.name ]);
                  });
              };
                  ...
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                      ...
                      if (v1.cursorPos instanceof Data_Maybe.Just) {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                              ...
                              $148.input = Data_String_CodePoints.take(v1.cursorPos.value0.col - 1 | 0)(v1.input) + Data_String_CodePoints.drop(v1.cursorPos.value0.col)(v1.input);
                              $148.inputMode = Inputting.value;
                              return $148;
                          }))(function () {
                              return handleAction(MoveCursor.create(v1.cursorPos.value0.col - 1 | 0));
                          });
                      };
                      throw new Error("Failed pattern match at Editor (line 226, column 7 - line 230, column 46): " + [ v1.cursorPos.constructor.name ]);
                  });
              };
                  ...
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                      ...
                      if (v1.cursorPos instanceof Data_Maybe.Just) {
                          return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                              ...
                              $159.input = Data_String_CodePoints.take(v1.cursorPos.value0.col)(v1.input) + Data_String_CodePoints.drop(v1.cursorPos.value0.col + 1 | 0)(v1.input);
                              $159.inputMode = Inputting.value;
                              return $159;
                          });
                      };
                      throw new Error("Failed pattern match at Editor (line 233, column 7 - line 235, column 131): " + [ v1.cursorPos.constructor.name ]);
                  });
              };
                      ...
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                          ...
                          if (v2 instanceof Data_Either.Right) {
                              return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                                  var $170 = {};
                                  for (var $171 in v3) {
                                      if ({}.hasOwnProperty.call(v3, $171)) {
                                          $170[$171] = v3[$171];
                                      };
                                  };
                                  $170.history = Data_Array.cons({
                                      input: v1.input,
                                      output: UntypedLambda.display(v2.value0.value0)
                                  })(v1.history);
                                  $170.env = v2.value0.value1;
                                  return $170;
                              });
                          };
                          if (v2 instanceof Data_Either.Left) {
                              return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                                  var $176 = {};
                                  for (var $177 in v3) {
                                      if ({}.hasOwnProperty.call(v3, $177)) {
                                          $176[$177] = v3[$177];
                                      };
                                  };
                                  $176.history = Data_Array.cons({
                                      input: v1.input,
                          ...
                          throw new Error("Failed pattern match at Editor (line 238, column 7 - line 248, column 85): " + [ v2.constructor.name ]);
                      })())(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                              var $180 = {};
                              for (var $181 in v2) {
              ...
              throw new Error("Failed pattern match at Editor (line 107, column 18 - line 250, column 34): " + [ v.constructor.name ]);
          };
      })();
  ...
  exports["Delete"] = Delete;
  exports["Eval"] = Eval;
  exports["HiddenReplInput"] = HiddenReplInput;
