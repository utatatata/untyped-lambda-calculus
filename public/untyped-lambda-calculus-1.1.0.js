      ...
      var handleAction = function (v) {
          ...
          if (v instanceof FocusById) {
              return Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(function __do() {
                  ...
                  throw new Error("Failed pattern match at Editor (line 81, column 13 - line 83, column 44): " + [ v4.constructor.name ]);
              });
          };
          if (v instanceof KeyDown) {
              var v1 = Web_UIEvent_KeyboardEvent.key(v.value0);
              if (v1 === "ArrowUp") {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Data_Functor.map(Halogen_Query_HalogenM.functorHalogenM)(function (v2) {
                      return v2.inputMode;
                  })(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM)))(function (v2) {
                      if (v2 instanceof Inputting) {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Data_Functor.mapFlipped(Halogen_Query_HalogenM.functorHalogenM)(Data_Functor.map(Halogen_Query_HalogenM.functorHalogenM)(function (v3) {
                              return v3.history;
                          })(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM)))(function (v3) {
                              return Data_Array.index(v3)(0);
                          }))(function (v3) {
                              if (v3 instanceof Data_Maybe.Nothing) {
                              ...
                              if (v3 instanceof Data_Maybe.Just) {
                                  return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v4) {
                                      ...
                                      $47.inputMode = new SelectingHistory(0);
                                      $47.input = v3.value0.input;
                                      return $47;
                                  });
                              };
                              throw new Error("Failed pattern match at Editor (line 91, column 23 - line 98, column 30): " + [ v3.constructor.name ]);
                          });
                      };
                      if (v2 instanceof SelectingHistory) {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Data_Functor.mapFlipped(Halogen_Query_HalogenM.functorHalogenM)(Data_Functor.map(Halogen_Query_HalogenM.functorHalogenM)(function (v3) {
                              return v3.history;
                          })(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM)))(function (v3) {
                              return Data_Array.index(v3)(v2.value0 + 1 | 0);
                          }))(function (v3) {
                              if (v3 instanceof Data_Maybe.Nothing) {
                                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
                              };
                              if (v3 instanceof Data_Maybe.Just) {
                                  return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v4) {
                                      ...
                                      $54.inputMode = SelectingHistory.create(v2.value0 + 1 | 0);
                                      $54.input = v3.value0.input;
                                      return $54;
                                  });
                              };
                              throw new Error("Failed pattern match at Editor (line 101, column 23 - line 108, column 30): " + [ v3.constructor.name ]);
                          });
                      };
                      throw new Error("Failed pattern match at Editor (line 88, column 15 - line 108, column 30): " + [ v2.constructor.name ]);
                  });
              };
              if (v1 === "ArrowDown") {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Data_Functor.map(Halogen_Query_HalogenM.functorHalogenM)(function (v2) {
                          ...
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Data_Functor.mapFlipped(Halogen_Query_HalogenM.functorHalogenM)(Data_Functor.map(Halogen_Query_HalogenM.functorHalogenM)(function (v3) {
                              ...
                              if (v3 instanceof Data_Maybe.Just) {
                                  return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v4) {
                                      ...
                                      $63.inputMode = SelectingHistory.create(v2.value0 - 1 | 0);
                                      $63.input = v3.value0.input;
                                      return $63;
                                  });
                              };
                              throw new Error("Failed pattern match at Editor (line 115, column 23 - line 122, column 30): " + [ v3.constructor.name ]);
                          });
                      };
                      throw new Error("Failed pattern match at Editor (line 111, column 15 - line 122, column 30): " + [ v2.constructor.name ]);
                  });
              };
              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
          };
              ...
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  ...
                  if (v2 instanceof Data_Either.Right) {
                      return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                          ...
                          $80.input = "";
                          $80.history = Data_Array.cons({
                              input: v1.input,
                              output: UntypedLambda.display(v2.value0.value0)
                          })(v1.history);
                          $80.env = v2.value0.value1;
                          return $80;
                      });
                  };
                  ...
                  throw new Error("Failed pattern match at Editor (line 127, column 7 - line 140, column 16): " + [ v2.constructor.name ]);
              });
          };
          throw new Error("Failed pattern match at Editor (line 71, column 18 - line 140, column 16): " + [ v.constructor.name ]);
      };
