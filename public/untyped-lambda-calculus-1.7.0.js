  ...
  var alphaConversion = function (v) {
      return function (v1) {
          ...
          if (v1 instanceof LambdaAbstraction) {
              var freeVars = freeVariables(v.value1);
              var shadowVar = function ($copy_n) {
                  var $tco_done = false;
                  var $tco_result;
                  function $tco_loop(n) {
                      var $$var = v1.value0 + ("_" + Data_Int.toStringAs(Data_Int.decimal)(n));
                      var $132 = Data_Foldable.notElem(Data_Foldable.foldableArray)(Data_Eq.eqString)($$var)(freeVars);
                      if ($132) {
                          $tco_done = true;
                          return $$var;
                      };
              ...
              var newReplacement = alphaConversion(new Substitution(v1.value0, Variable.create(shadowVar(0))))(v.value1);
              return alphaConversion(new Substitution(v.value0, newReplacement))(v1);
          };
