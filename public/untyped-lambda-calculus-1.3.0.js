...
(function($PS) {
  ...
  var toString = function (v) {
      ...
      throw new Error("Failed pattern match at Editor (line 78, column 1 - line 78, column 25): " + [ v.constructor.name ]);
  };
  var main = (function () {
          ...
          return function (v) {
              ...
              if (v instanceof FocusById) {
                  return Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(function __do() {
                      ...
                      throw new Error("Failed pattern match at Editor (line 118, column 13 - line 122, column 34): " + [ v2.constructor.name ]);
                  });
              };
              if (v instanceof HistoryUp) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                      var n = (function () {
                          ...
                          throw new Error("Failed pattern match at Editor (line 127, column 15 - line 129, column 52): " + [ v1.inputMode.constructor.name ]);
                      })();
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v2) {
                          ...
                          throw new Error("Failed pattern match at Editor (line 133, column 13 - line 141, column 59): " + [ v3.constructor.name ]);
                      });
                  });
              };
                  ...
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                      ...
                      if (v1.inputMode instanceof SelectingHistory) {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v2) {
                              ...
                              throw new Error("Failed pattern match at Editor (line 156, column 11 - line 164, column 57): " + [ v3.constructor.name ]);
                          });
                      };
                      throw new Error("Failed pattern match at Editor (line 145, column 7 - line 164, column 57): " + [ v1.inputMode.constructor.name ]);
                  });
              };
                  ...
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                      ...
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(function __do() {
                          ...
                          if (v2 instanceof Data_Maybe.Just) {
                              ...
                              throw new Error("Failed pattern match at Editor (line 180, column 25 - line 182, column 141): " + [ v4.constructor.name ]);
                          };
                          throw new Error("Failed pattern match at Editor (line 176, column 21 - line 182, column 141): " + [ v2.constructor.name ]);
                      }))(function (v2) {
                          if (v2 instanceof Data_Maybe.Nothing) {
                              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
                          };
                          ...
                          throw new Error("Failed pattern match at Editor (line 184, column 13 - line 187, column 104): " + [ v2.constructor.name ]);
                      });
                  });
              };
              if (v instanceof MoveCursorLeft) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                      ...
                      throw new Error("Failed pattern match at Editor (line 191, column 7 - line 193, column 77): " + [ v1.cursorPos.constructor.name ]);
                  });
              };
              if (v instanceof MoveCursorRight) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                      ...
                      throw new Error("Failed pattern match at Editor (line 196, column 7 - line 198, column 77): " + [ v1.cursorPos.constructor.name ]);
                  });
              };
              ...
              if (v instanceof Insert) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                      ...
                      throw new Error("Failed pattern match at Editor (line 213, column 7 - line 222, column 12): " + [ v1.cursorPos.constructor.name ]);
                  });
              };
              if (v instanceof Backspace) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                      ...
                      throw new Error("Failed pattern match at Editor (line 225, column 7 - line 229, column 46): " + [ v1.cursorPos.constructor.name ]);
                  });
              };
              if (v instanceof Delete) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                      ...
                      throw new Error("Failed pattern match at Editor (line 232, column 7 - line 234, column 131): " + [ v1.cursorPos.constructor.name ]);
                  });
              };
              if (v instanceof Eval) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                          ...
                          throw new Error("Failed pattern match at Editor (line 237, column 7 - line 247, column 85): " + [ v2.constructor.name ]);
                      })())(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                              var $180 = {};
                              for (var $181 in v2) {
              ...
              throw new Error("Failed pattern match at Editor (line 106, column 18 - line 249, column 34): " + [ v.constructor.name ]);
          };
      })();
