...
>>>>>>> master:public/untyped-lambda-calculus-1.2.0.js
  ...
  var Composition = (function () {
      function Composition(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      Composition.create = function (value0) {
          return function (value1) {
              return new Composition(value0, value1);
          };
      };
      return Composition;
  })();
...
>>>>>>> master:public/untyped-lambda-calculus-1.2.0.js
      ...
      var handleAction = function (v) {
          if (v instanceof Composition) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(handleAction(v.value0))(function () {
          ...
          if (v instanceof StopPropagation) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Web_Event_Event.stopPropagation(v.value0)))(function () {
                  return handleAction(v.value1);
              });
          };
          if (v instanceof FocusById) {
              return Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(function __do() {
                  ...
                  var v3 = Web_DOM_NonElementParentNode.getElementById(v.value0)(Web_HTML_HTMLDocument.toNonElementParentNode(v2))();
                  var v4 = Control_Bind.bind(Data_Maybe.bindMaybe)(v3)(Web_HTML_HTMLElement.fromElement);
...
<<<<<<< HEAD:public/untyped-lambda-calculus-1.1.0.js
                      ...
                      throw new Error("Failed pattern match at Editor (line 115, column 15 - line 117, column 52): " + [ v1.inputMode.constructor.name ]);
                  })();
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v2) {
                      ...
                      if (v3 instanceof Data_Maybe.Just) {
                          return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v4) {
                              ...
                              $54.inputMode = new SelectingHistory(n);
                              $54.input = v3.value0.input;
                              $54.cursorPos = {
                                  col: Data_String_CodePoints.length(v3.value0.input),
                                  x: 0.0,
                                  y: 0.0
                              };
                              return $54;
                      ...
                      throw new Error("Failed pattern match at Editor (line 121, column 13 - line 129, column 22): " + [ v3.constructor.name ]);
                  });
              });
          };
                      ...
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v2) {
                          ...
                          if (v3 instanceof Data_Maybe.Just) {
                              return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v4) {
                                  ...
                                  $70.inputMode = SelectingHistory.create(v1.inputMode.value0 - 1 | 0);
                                  $70.input = v3.value0.input;
                                  $70.cursorPos = {
                                      col: Data_String_CodePoints.length(v3.value0.input),
                                      x: 0.0,
                                      y: 0.0
                          ...
                          throw new Error("Failed pattern match at Editor (line 144, column 11 - line 152, column 20): " + [ v3.constructor.name ]);
                      });
                  };
                  throw new Error("Failed pattern match at Editor (line 133, column 7 - line 152, column 20): " + [ v1.inputMode.constructor.name ]);
              });
          };
          ...
          if (v instanceof Insert) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  var v2 = Data_String_CodeUnits.splitAt(v1.cursorPos.col)(v1.input);
                  return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                      ...
                      $88.input = v2.before + (Data_String_CodeUnits.singleton(v.value0) + v2.after);
                      $88.cursorPos = {
                          col: v1.cursorPos.col + 1 | 0,
                          x: 0.0,
                          y: 0.0
                      };
                      return $88;
          ...
          if (v instanceof Backspace) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                      ...
                      $97.input = Data_String_CodePoints.take(v1.cursorPos.col - 1 | 0)(v1.input) + Data_String_CodePoints.drop(v1.cursorPos.col)(v1.input);
                      $97.cursorPos = {
                          col: Data_Ord.max(Data_Ord.ordInt)(0)(v1.cursorPos.col - 1 | 0),
                          x: 0.0,
                          y: 0.0
                      };
                      return $97;
          ...
          if (v instanceof Delete) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                      ...
                      $103.input = Data_String_CodePoints.take(v1.cursorPos.col)(v1.input) + Data_String_CodePoints.drop(v1.cursorPos.col + 1 | 0)(v1.input);
                      $103.cursorPos = {
                          col: v1.cursorPos.col,
                          x: 0.0,
                          y: 0.0
                      };
                      return $103;
...
<<<<<<< HEAD:public/untyped-lambda-calculus-1.1.0.js
                          ...
                          $113.input = "";
                          $113.inputMode = Inputting.value;
                          $113.cursorPos = {
                              col: 0,
                              x: 0.0,
                              y: 0.0
                          };
                          $113.history = Data_Array.cons({
                              input: v1.input,
...
<<<<<<< HEAD:public/untyped-lambda-calculus-1.1.0.js
                          ...
                          $119.input = "";
                          $119.inputMode = Inputting.value;
                          $119.cursorPos = {
                              col: 0,
                              x: 0.0,
                              y: 0.0
                          };
                          $119.history = Data_Array.cons({
                              input: v1.input,
                  ...
                  throw new Error("Failed pattern match at Editor (line 200, column 7 - line 217, column 16): " + [ v2.constructor.name ]);
              });
          };
