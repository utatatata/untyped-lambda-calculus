...
(function($PS) {
  ...
  var display = (function () {
      ...
      return function (v) {
          ...
          if (v instanceof LambdaAbstraction && v.value1 instanceof LambdaAbstraction) {
              return "\u03bb" + (v.value0 + (" " + Data_String_CodePoints.drop(1)(display(v.value1))));
          };
          if (v instanceof LambdaAbstraction) {
              return "\u03bb" + (v.value0 + ("." + display(v.value1)));
          };
          if (v instanceof Application) {
              return Data_String_Common.joinWith(" ")([ (function () {
                  ...
                  if (v.value0 instanceof LambdaAbstraction) {
                      return paren(display(v.value0));
                  };
                  if (v.value0 instanceof Application) {
                      return display(v.value0);
                  };
                  throw new Error("Failed pattern match at UntypedLambda.Core (line 54, column 9 - line 59, column 47): " + [ v.value0.constructor.name ]);
              })(), (function () {
                  if (v.value1 instanceof Variable) {
                      return v.value1.value0;
                  };
                  if (v.value1 instanceof LambdaAbstraction) {
                      return paren(display(v.value1));
                  };
                  if (v.value1 instanceof Application) {
                      return paren(display(v.value1));
                  };
                  throw new Error("Failed pattern match at UntypedLambda.Core (line 60, column 9 - line 66, column 55): " + [ v.value1.constructor.name ]);
              })() ]);
          };
          throw new Error("Failed pattern match at UntypedLambda.Core (line 47, column 11 - line 67, column 8): " + [ v.constructor.name ]);
      };
  })();
  var asExpression = function (v) {
      ...
      throw new Error("Failed pattern match at UntypedLambda.Core (line 147, column 1 - line 147, column 36): " + [ v.constructor.name ]);
  };
  ...
  var callByValue = function (v) {
      ...
      if (v instanceof Application) {
          return (function (v1) {
              ...
              throw new Error("Failed pattern match at UntypedLambda.Core (line 163, column 7 - line 166, column 75): " + [ v1.constructor.name ]);
          })(callByValue(v.value0));
      };
      throw new Error("Failed pattern match at UntypedLambda.Core (line 156, column 1 - line 156, column 35): " + [ v.constructor.name ]);
  };
      ...
      return function ($copy_v) {
          ...
          function $tco_loop(input, v) {
              if (v.inputMode instanceof Multiline) {
                  var endMultiline = Data_Functor.voidRight(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(EndMultiline.value)(Control_Apply.applyFirst(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(UntypedLambda_Parser.spaces(Data_Identity.monadIdentity))(Text_Parsing_Parser_String.string(Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)(".end")))(Text_Parsing_Parser_String.eof(Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)));
                  ...
                  throw new Error("Failed pattern match at UntypedLambda.REPL (line 66, column 82 - line 73, column 63): " + [ v1.constructor.name ]);
              };
              var startMultiline = Data_Functor.voidRight(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(StartMultiline.value)(Control_Apply.applyFirst(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(UntypedLambda_Parser.spaces(Data_Identity.monadIdentity))(Text_Parsing_Parser_String.string(Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)(".multi")))(Text_Parsing_Parser_String.eof(Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)));
              var endMultiline = Data_Functor.voidRight(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(EndMultiline.value)(Control_Apply.applyFirst(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(UntypedLambda_Parser.spaces(Data_Identity.monadIdentity))(Text_Parsing_Parser_String.string(Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)(".end")))(Text_Parsing_Parser_String.eof(Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)));
              ...
              var parser = Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser_Combinators["try"](Data_Identity.monadIdentity)(startMultiline))(Text_Parsing_Parser_Combinators["try"](Data_Identity.monadIdentity)(endMultiline)))(Text_Parsing_Parser_Combinators["try"](Data_Identity.monadIdentity)(define)))(_expression);
              ...
              if (v1 instanceof Data_Either.Right && v1.value0 instanceof Definition) {
                  ...
                  return REPL({
                      ...
                      history: Data_Array.snoc(v.history)({
                          input: input,
                          output: Data_Maybe.Just.create(UntypedLambda_Core.display(UntypedLambda_Core.asExpression(value)))
                      }),
                      inputMode: v.inputMode,
                      inputPool: v.inputPool
                  });
              ...
              if (v1 instanceof Data_Either.Right && v1.value0 instanceof Expression) {
                  ...
                  return REPL({
                      ...
                      history: Data_Array.snoc(v.history)({
                          input: input,
                          output: Data_Maybe.Just.create(UntypedLambda_Core.display(UntypedLambda_Core.asExpression(UntypedLambda_Core.callByValue(UntypedLambda_Core.withEnvironment(v.env)(v1.value0.value0)))))
                      }),
                      inputMode: v.inputMode,
                      inputPool: v.inputPool
                  });
              ...
              throw new Error("Failed pattern match at UntypedLambda.REPL (line 77, column 26 - line 132, column 14): " + [ v1.constructor.name ]);
          };
          while (!$tco_done) {
...
(function($PS) {
  ...
  var showInputMode = new Data_Show.Show(function (v) {
      if (v instanceof Inputting) {
          return "Inputting";
      };
      if (v instanceof SelectingHistory) {
          return "(SelectingHistory " + (Data_Show.show(Data_Show.showInt)(v.value0) + ")");
      };
      throw new Error("Failed pattern match at Editor (line 40, column 1 - line 42, column 68): " + [ v.constructor.name ]);
  });
  var getString = function (v) {
      ...
      throw new Error("Failed pattern match at Editor (line 59, column 1 - line 59, column 26): " + [ v.constructor.name ]);
  };
  var main = (function () {
              ...
              return function (mode) {
                  var prompt = function (withPrompt) {
                      return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ "flex", "justify-end" ])((function () {
                          ...
                          throw new Error("Failed pattern match at Editor (line 308, column 18 - line 310, column 64): " + [ withPrompt.constructor.name ]);
                      })())) ])([ Halogen_HTML_Elements.span([ Halogen_HTML_Properties.classes([ "mr-1" ]) ])([ Halogen_HTML_Core.text(">") ]) ]);
                  };
                  if (mode instanceof Dummy) {
                      return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ "flex" ])(classes)) ])(Data_Array.cons(prompt(WithPrompt.value))([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "w-full", "bg-gray-800" ]) ])([ mode.value0 ]) ]));
                  };
                  if (mode instanceof TextArea) {
                      return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ "flex" ])(classes)) ])(Data_Array.cons(prompt(mode.value0))([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "flex", "relative", "w-full" ]) ])([ Halogen_HTML_Elements.textarea([ Halogen_HTML_Properties.id_(getString(TextAreaId.value)), Halogen_HTML_Properties.classes([ "w-full", "apperance-none", "focus:outline-none", "bg-gray-800", "resize-none", "overflow-y-hidden", "z-10" ]), Halogen_HTML_Properties.rows(state.textAreaRows), Halogen_HTML_Properties.autofocus(true), Halogen_HTML_Properties.value(state.input), Halogen_HTML_Events.onKeyDown(function ($107) {
                          return Data_Maybe.Just.create(KeyDown.create($107));
                      }), Halogen_HTML_Events.onKeyUp(function ($108) {
                          return Data_Maybe.Just.create(KeyUp.create($108));
                      }), Halogen_HTML_Events.onValueInput(function ($109) {
                          return Data_Maybe.Just.create(Input.create($109));
                  ...
                  throw new Error("Failed pattern match at Editor (line 255, column 30 - line 302, column 14): " + [ mode.constructor.name ]);
              };
          };
          var repl = Data_Newtype.unwrap(UntypedLambda_REPL.newtypeREPL)(state.repl);
          return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.header([ Halogen_HTML_Properties.classes([ "flex", "justify-between", "my-4" ]) ])([ Halogen_HTML_Elements.h1([ Halogen_HTML_Properties.classes([ "mx-6", "text-3xl" ]) ])([ Halogen_HTML_Elements.span([ Halogen_HTML_Properties.classes([ "inline-block", "w-12", "h-12", "rounded-full", "bg-indigo-800", "align-middle", "text-center", "font-black" ]) ])([ Halogen_HTML_Elements.span([ Halogen_HTML_Properties.classes([ "inline-block", "pt-1" ]) ])([ Halogen_HTML_Core.text("\u03bb") ]) ]) ]), Halogen_HTML_Elements.nav([ Halogen_HTML_Properties.classes([ "mx-2" ]) ])([ Halogen_HTML_Elements.ul([ Halogen_HTML_Properties.classes([ "flex", "justify-end" ]) ])([ Halogen_HTML_Elements.li_([ Halogen_HTML_Elements.a([ Halogen_HTML_Properties.target("_blank"), Halogen_HTML_Properties.href("https://github.com/utatatata/untyped-lambda-calculus") ])([ Halogen_HTML_Core.text("GitHub") ]) ]) ]) ]) ]), Halogen_HTML_Elements.main([ Halogen_HTML_Properties.classes([ "mx-4", "w-auto" ]) ])([ Halogen_HTML_Elements.section_([ Halogen_HTML_Elements.h2_([ Halogen_HTML_Core.text("REPL") ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "flex", "flex-col" ]) ])(Data_Functor.map(Data_Functor.functorArray)(function (v) {
              return Halogen_HTML_Elements.div_(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ inputLine([  ])(Dummy.create(Halogen_HTML_Elements.span([ Halogen_HTML_Properties.classes([ "break-all", "whitespace-pre-wrap" ]) ])([ Halogen_HTML_Core.text(v.input) ]))) ])((function () {
                  if (v.output instanceof Data_Maybe.Just) {
                      return [ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "mb-4", "break-all" ]) ])([ Halogen_HTML_Core.text(v.output.value0) ]) ];
                  };
                  if (v.output instanceof Data_Maybe.Nothing) {
                      return [  ];
                  };
                  throw new Error("Failed pattern match at Editor (line 225, column 30 - line 227, column 44): " + [ v.output.constructor.name ]);
              })()));
              ...
              if (repl.inputMode instanceof UntypedLambda_REPL.Multiline) {
                  var $40 = Data_Eq.eq(Data_Eq.eqArray(Data_Eq.eqString))(repl.inputPool)([  ]);
                  if ($40) {
                      return [ "hidden" ];
                  };
                  return [  ];
              };
              throw new Error("Failed pattern match at Editor (line 229, column 23 - line 235, column 31): " + [ repl.inputMode.constructor.name ]);
              ...
              if (repl.inputMode instanceof UntypedLambda_REPL.Multiline) {
                  var $42 = Data_Eq.eq(Data_Eq.eqArray(Data_Eq.eqString))(repl.inputPool)([  ]);
                  if ($42) {
                      return WithPrompt.value;
                  };
                  return WithoutPrompt.value;
              };
              throw new Error("Failed pattern match at Editor (line 244, column 23 - line 250, column 42): " + [ repl.inputMode.constructor.name ]);
          })())) ]) ]) ]);
      };
              ...
              if (v instanceof Eval) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                      return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                          ...
                          $52.input = "";
                          $52.textAreaRows = 1;
                          $52.inputMode = Inputting.value;
                          $52.repl = UntypedLambda_REPL["eval"](v1.input)(v1.repl);
                          return $52;
                      });
                  });
              };
              ...
              if (v instanceof CalculateTextAreaRows) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(function __do() {
                      ...
                      if (v1 instanceof Data_Maybe.Just) {
                          ...
                          var $65 = last === "" || (last === "\x0a" || last === "\x0d");
                          if ($65) {
                              return Data_Maybe.Just.create(rows + 1 | 0);
                          };
                          return new Data_Maybe.Just(rows);
                      };
                      throw new Error("Failed pattern match at Editor (line 125, column 15 - line 140, column 20): " + [ v1.constructor.name ]);
                  }))(function (v1) {
                      if (v1 instanceof Data_Maybe.Nothing) {
                          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
                      };
                      if (v1 instanceof Data_Maybe.Just) {
                          return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                              ...
                              $69.textAreaRows = v1.value0;
                              return $69;
                          });
                      };
                      throw new Error("Failed pattern match at Editor (line 141, column 7 - line 143, column 57): " + [ v1.constructor.name ]);
                  });
              };
              if (v instanceof HistoryUp) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                      var n = (function () {
                          ...
                          throw new Error("Failed pattern match at Editor (line 147, column 15 - line 149, column 52): " + [ v1.inputMode.constructor.name ]);
                      })();
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v2) {
                          ...
                          if (v3 instanceof Data_Maybe.Just) {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v4) {
                                  ...
                                  $79.input = v3.value0.input;
                                  $79.inputMode = new SelectingHistory(n);
                                  return $79;
                              }))(function () {
                                  return handleAction(new CalculateTextAreaRows(v3.value0.input));
                              });
                          };
                          throw new Error("Failed pattern match at Editor (line 153, column 13 - line 158, column 59): " + [ v3.constructor.name ]);
                      });
                  });
              };
                          ...
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v2) {
                              ...
                              if (v3 instanceof Data_Maybe.Just) {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v4) {
                                      ...
                                      $96.input = v3.value0.input;
                                      $96.inputMode = SelectingHistory.create(v1.inputMode.value0 - 1 | 0);
                                      return $96;
                                  }))(function () {
                                      return handleAction(new CalculateTextAreaRows(v3.value0.input));
                                  });
                              };
                              throw new Error("Failed pattern match at Editor (line 167, column 11 - line 171, column 57): " + [ v3.constructor.name ]);
                          });
                      };
                      throw new Error("Failed pattern match at Editor (line 162, column 7 - line 171, column 57): " + [ v1.inputMode.constructor.name ]);
                  });
              };
              throw new Error("Failed pattern match at Editor (line 94, column 18 - line 171, column 57): " + [ v.constructor.name ]);
          };
      })();
  ...
  exports["main"] = main;
  exports["showInputMode"] = showInputMode;
})(PS);
PS["Editor"].main();