...
(function($PS) {
  ...
  var getString = function (v) {
      ...
      throw new Error("Failed pattern match at Editor (line 92, column 1 - line 92, column 26): " + [ v.constructor.name ]);
  };
  var main = (function () {
      var render = function (state) {
              ...
              return function (mode) {
                  var prompt = function (withPrompt) {
                      return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ "flex", "justify-end" ])((function () {
                          ...
                          throw new Error("Failed pattern match at Editor (line 634, column 18 - line 636, column 64): " + [ withPrompt.constructor.name ]);
                  ...
                  if (mode instanceof TextArea) {
                      return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ "flex", "font-mono" ])(classes)) ])(Data_Array.cons(prompt(mode.value0))([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "flex", "relative", "w-full" ]) ])([ Halogen_HTML_Elements.textarea([ Halogen_HTML_Properties.id_(getString(TextAreaId.value)), Halogen_HTML_Properties.classes([ "w-full", "apperance-none", "focus:outline-none", "bg-gray-800", "resize-none", "overflow-y-hidden", "z-10", "break-all" ]), Halogen_HTML_Properties.rows(state.textAreaRows), Halogen_HTML_Properties.autofocus(true), Halogen_HTML_Properties.value(state.input), Halogen_HTML_Events.onKeyDown(function ($161) {
                          return Data_Maybe.Just.create(KeyDown.create($161));
                      }), Halogen_HTML_Events.onKeyUp(function ($162) {
                          return Data_Maybe.Just.create(KeyUp.create($162));
                      }), Halogen_HTML_Events.onValueInput(function ($163) {
                          return Data_Maybe.Just.create(Input.create($163));
                  ...
                  throw new Error("Failed pattern match at Editor (line 580, column 30 - line 628, column 14): " + [ mode.constructor.name ]);
              };
          };
          ...
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "min-w-full", "min-h-full", "bg-gray-900", "text-white", "text-base", "font-sans" ]), Halogen_HTML_Events.onClick(Data_Function["const"](new Data_Maybe.Just(HiddenSelectOrCopyPopup.value))) ])([ Halogen_HTML_Elements.header([ Halogen_HTML_Properties.classes([ "flex", "justify-between", "py-4" ]) ])([ Halogen_HTML_Elements.h1([ Halogen_HTML_Properties.classes([ "mx-6", "text-3xl" ]) ])([ Halogen_HTML_Elements.span([ Halogen_HTML_Properties.classes([ "inline-block", "w-12", "h-12", "rounded-full", "bg-indigo-800", "align-middle", "text-center", "font-black", "font-mono" ]) ])([ Halogen_HTML_Elements.span([ Halogen_HTML_Properties.classes([ "inline-block", "pt-1" ]) ])([ Halogen_HTML_Core.text("\u03bb") ]) ]) ]), Halogen_HTML_Elements.nav([ Halogen_HTML_Properties.classes([ "mx-2" ]) ])([ Halogen_HTML_Elements.ul([ Halogen_HTML_Properties.classes([ "flex", "justify-end" ]) ])([ Halogen_HTML_Elements.li_([ Halogen_HTML_Elements.a([ Halogen_HTML_Properties.target("_blank"), Halogen_HTML_Properties.href("https://github.com/utatatata/untyped-lambda-calculus") ])([ Halogen_HTML_Core.text("GitHub") ]) ]) ]) ]) ]), Halogen_HTML_Elements.main([ Halogen_HTML_Properties.classes([ "mx-4", "w-auto", "border-2", "border-gray-800", "rounded", "p-2" ]) ])([ Halogen_HTML_Elements.ul([ Halogen_HTML_Properties.classes([ "flex", "mb-5", "text-gray-400" ]) ])((function () {
              ...
              throw new Error("Failed pattern match at Editor (line 379, column 21 - line 449, column 26): " + [ state.popupState.constructor.name ]);
              ...
              return Halogen_HTML_Elements.div_(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ inputLine([  ])(Dummy.create(Halogen_HTML_Elements.span([ Halogen_HTML_Properties.classes([ "inline-block", "w-full", "break-all", "whitespace-pre-wrap" ]), Halogen_HTML_Events.onClick(function (me) {
                  ...
                  throw new Error("Failed pattern match at Editor (line 470, column 32 - line 482, column 46): " + [ v.output.constructor.name ]);
              })()));
              ...
              if (repl.inputMode instanceof UntypedLambda_REPL.Multiline) {
                  var $59 = Data_Eq.eq(Data_Eq.eqArray(Data_Eq.eqString))(repl.inputPool)([  ]);
                  if ($59) {
                      return [ "hidden" ];
                  };
                  return [  ];
              };
              throw new Error("Failed pattern match at Editor (line 485, column 25 - line 491, column 33): " + [ repl.inputMode.constructor.name ]);
              ...
              throw new Error("Failed pattern match at Editor (line 500, column 25 - line 506, column 44): " + [ repl.inputMode.constructor.name ]);
          })())) ])), Halogen_HTML_Elements.section([ Halogen_HTML_Properties.classes((function () {
              if (state.tab instanceof Environment) {
                  return [  ];
              };
          ...
          var copyListener = function (str) {
              return function (event) {
                  return function __do() {
                      ...
                      throw new Error("Failed pattern match at Editor (line 251, column 7 - line 255, column 34): " + [ v1.constructor.name ]);
                  };
              };
          };
          ...
          return function (v) {
                  ...
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(handleAction(HiddenSelectOrCopyPopup.value))(function () {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                          return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                              ...
                              $80.input = "";
                              $80.textAreaRows = 1;
                              $80.inputMode = Inputting.value;
                              $80.repl = UntypedLambda_REPL["eval"](v1.input)(v1.repl);
                              return $80;
                          });
                      });
                  });
              ...
              if (v instanceof KeyUp) {
                  ...
                  if (v1 === "Enter") {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v2) {
                          var $89 = Data_String_Common["null"](Data_String_Common.trim(v2.input));
                          if ($89) {
                              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
                          };
              ...
              if (v instanceof CalculateTextAreaRows) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(function __do() {
                      ...
                      if (v1 instanceof Data_Maybe.Just) {
                          ...
                          var $96 = last === "" || (last === "\x0a" || last === "\x0d");
                          if ($96) {
                              return Data_Maybe.Just.create(rows + 1 | 0);
                          };
                          return new Data_Maybe.Just(rows);
                      };
                      throw new Error("Failed pattern match at Editor (line 167, column 15 - line 182, column 20): " + [ v1.constructor.name ]);
                  }))(function (v1) {
                      if (v1 instanceof Data_Maybe.Nothing) {
                          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
                      };
                      if (v1 instanceof Data_Maybe.Just) {
                          return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                              ...
                              $100.textAreaRows = v1.value0;
                              return $100;
                          });
                      };
                      throw new Error("Failed pattern match at Editor (line 183, column 7 - line 185, column 57): " + [ v1.constructor.name ]);
                  });
              };
                  ...
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(handleAction(HiddenSelectOrCopyPopup.value))(function () {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                          var n = (function () {
                              ...
                              throw new Error("Failed pattern match at Editor (line 190, column 15 - line 192, column 52): " + [ v1.inputMode.constructor.name ]);
                          })();
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v2) {
                              ...
                              if (v3 instanceof Data_Maybe.Just) {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v4) {
                                      ...
                                      $110.input = v3.value0.input;
                                      $110.inputMode = new SelectingHistory(n);
                                      return $110;
                                  }))(function () {
                                      return handleAction(new CalculateTextAreaRows(v3.value0.input));
                                  });
                              };
                              throw new Error("Failed pattern match at Editor (line 196, column 13 - line 201, column 59): " + [ v3.constructor.name ]);
                          });
                      });
                  });
              };
                              ...
                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v2) {
                                  ...
                                  if (v3 instanceof Data_Maybe.Just) {
                                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v4) {
                                          ...
                                          $127.input = v3.value0.input;
                                          $127.inputMode = SelectingHistory.create(v1.inputMode.value0 - 1 | 0);
                                          return $127;
                                      }))(function () {
                                          return handleAction(new CalculateTextAreaRows(v3.value0.input));
                                      });
                                  };
                                  throw new Error("Failed pattern match at Editor (line 211, column 11 - line 215, column 57): " + [ v3.constructor.name ]);
                              });
                          };
                          throw new Error("Failed pattern match at Editor (line 206, column 7 - line 215, column 57): " + [ v1.inputMode.constructor.name ]);
                      });
                  });
              };
              ...
              if (v instanceof FocusById) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(handleAction(HiddenSelectOrCopyPopup.value))(function () {
                      return Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(function __do() {
                          ...
                          throw new Error("Failed pattern match at Editor (line 224, column 13 - line 226, column 35): " + [ v2.constructor.name ]);
                      });
                  });
              };
              if (v instanceof DisplaySelectOrCopyPopup) {
                  return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                      ...
                      $145.popupState = new Display(v.value0, {
              ...
              throw new Error("Failed pattern match at Editor (line 129, column 18 - line 241, column 22): " + [ v.constructor.name ]);
          };
      })();
