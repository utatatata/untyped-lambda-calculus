...
(function($PS) {
  ...
  var getString = function (v) {
      ...
      if (v instanceof BehindTextAreaId) {
          return "behind-text-area-id";
      };
      throw new Error("Failed pattern match at Editor (line 67, column 1 - line 67, column 26): " + [ v.constructor.name ]);
  };
  var main = (function () {
      var render = function (state) {
              ...
              return function (mode) {
                  var prompt = function (withPrompt) {
                      return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ "flex", "justify-end" ])((function () {
                          ...
                          throw new Error("Failed pattern match at Editor (line 457, column 18 - line 459, column 64): " + [ withPrompt.constructor.name ]);
                  ...
                  if (mode instanceof TextArea) {
                      return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ "flex", "font-mono" ])(classes)) ])(Data_Array.cons(prompt(mode.value0))([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "flex", "relative", "w-full" ]) ])([ Halogen_HTML_Elements.textarea([ Halogen_HTML_Properties.id_(getString(TextAreaId.value)), Halogen_HTML_Properties.classes([ "w-full", "apperance-none", "focus:outline-none", "bg-gray-800", "resize-none", "overflow-y-hidden", "z-10", "break-all" ]), Halogen_HTML_Properties.rows(state.textAreaRows), Halogen_HTML_Properties.autofocus(true), Halogen_HTML_Properties.value(state.input), Halogen_HTML_Events.onKeyDown(function ($125) {
                          return Data_Maybe.Just.create(KeyDown.create($125));
                      }), Halogen_HTML_Events.onKeyUp(function ($126) {
                          return Data_Maybe.Just.create(KeyUp.create($126));
                      }), Halogen_HTML_Events.onValueInput(function ($127) {
                          return Data_Maybe.Just.create(Input.create($127));
          ...
          return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.header([ Halogen_HTML_Properties.classes([ "flex", "justify-between", "my-4" ]) ])([ Halogen_HTML_Elements.h1([ Halogen_HTML_Properties.classes([ "mx-6", "text-3xl" ]) ])([ Halogen_HTML_Elements.span([ Halogen_HTML_Properties.classes([ "inline-block", "w-12", "h-12", "rounded-full", "bg-indigo-800", "align-middle", "text-center", "font-black", "font-mono" ]) ])([ Halogen_HTML_Elements.span([ Halogen_HTML_Properties.classes([ "inline-block", "pt-1" ]) ])([ Halogen_HTML_Core.text("\u03bb") ]) ]) ]), Halogen_HTML_Elements.nav([ Halogen_HTML_Properties.classes([ "mx-2" ]) ])([ Halogen_HTML_Elements.ul([ Halogen_HTML_Properties.classes([ "flex", "justify-end" ]) ])([ Halogen_HTML_Elements.li_([ Halogen_HTML_Elements.a([ Halogen_HTML_Properties.target("_blank"), Halogen_HTML_Properties.href("https://github.com/utatatata/untyped-lambda-calculus") ])([ Halogen_HTML_Core.text("GitHub") ]) ]) ]) ]) ]), Halogen_HTML_Elements.main([ Halogen_HTML_Properties.classes([ "mx-4", "w-auto", "border-2", "border-gray-800", "rounded", "p-2" ]) ])([ Halogen_HTML_Elements.ul([ Halogen_HTML_Properties.classes([ "flex", "mb-5", "text-gray-400" ]) ])((function () {
              ...
              return [ Halogen_HTML_Elements.li([ Halogen_HTML_Properties.classes(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ "mr-5" ])((function () {
                  ...
                  return [  ];
              })())) ])([ Halogen_HTML_Elements.a([ Halogen_HTML_Properties.classes([ "cursor-default" ]), Halogen_HTML_Events.onClick(function (e) {
                  return Data_Maybe.Just.create(new Composition([ PreventDefault.create(Web_UIEvent_MouseEvent.toEvent(e)), new SwitchTab(REPL.value), new FocusById(TextAreaId.value) ]));
                  ...
                  return Data_Maybe.Just.create(new Composition([ PreventDefault.create(Web_UIEvent_MouseEvent.toEvent(e)), new SwitchTab(Environment.value) ]));
                  ...
                  return Data_Maybe.Just.create(new Composition([ PreventDefault.create(Web_UIEvent_MouseEvent.toEvent(e)), new SwitchTab(Help.value) ]));
              ...
              return Halogen_HTML_Elements.div_(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ inputLine([  ])(Dummy.create(Halogen_HTML_Elements.span([ Halogen_HTML_Properties.classes([ "break-all", "whitespace-pre-wrap" ]) ])([ Halogen_HTML_Core.text(v.input) ]))) ])((function () {
                  ...
                  throw new Error("Failed pattern match at Editor (line 302, column 30 - line 309, column 44): " + [ v.output.constructor.name ]);
              })()));
              ...
              if (repl.inputMode instanceof UntypedLambda_REPL.Multiline) {
                  var $45 = Data_Eq.eq(Data_Eq.eqArray(Data_Eq.eqString))(repl.inputPool)([  ]);
                  if ($45) {
                      return [ "hidden" ];
                  };
                  return [  ];
              };
              throw new Error("Failed pattern match at Editor (line 311, column 23 - line 317, column 31): " + [ repl.inputMode.constructor.name ]);
              ...
              if (repl.inputMode instanceof UntypedLambda_REPL.Multiline) {
                  var $47 = Data_Eq.eq(Data_Eq.eqArray(Data_Eq.eqString))(repl.inputPool)([  ]);
                  if ($47) {
                      return WithPrompt.value;
                  };
                  return WithoutPrompt.value;
              };
              throw new Error("Failed pattern match at Editor (line 326, column 23 - line 332, column 42): " + [ repl.inputMode.constructor.name ]);
          })())) ]), Halogen_HTML_Elements.section([ Halogen_HTML_Properties.classes((function () {
              if (state.tab instanceof Environment) {
                  return [  ];
              };
          ...
          return function (v) {
              ...
              if (v instanceof Eval) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                      return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                          ...
                          $62.input = "";
                          $62.textAreaRows = 1;
                          $62.inputMode = Inputting.value;
                          $62.repl = UntypedLambda_REPL["eval"](v1.input)(v1.repl);
                          return $62;
                      });
                  });
              };
              ...
              if (v instanceof CalculateTextAreaRows) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(function __do() {
                      ...
                      if (v1 instanceof Data_Maybe.Just) {
                          ...
                          var $75 = last === "" || (last === "\x0a" || last === "\x0d");
                          if ($75) {
                              return Data_Maybe.Just.create(rows + 1 | 0);
                          };
                          return new Data_Maybe.Just(rows);
                      };
                      throw new Error("Failed pattern match at Editor (line 134, column 15 - line 149, column 20): " + [ v1.constructor.name ]);
                  }))(function (v1) {
                      if (v1 instanceof Data_Maybe.Nothing) {
                          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
                      };
                      if (v1 instanceof Data_Maybe.Just) {
                          return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                              ...
                              $79.textAreaRows = v1.value0;
                              return $79;
                          });
                      };
                      throw new Error("Failed pattern match at Editor (line 150, column 7 - line 152, column 57): " + [ v1.constructor.name ]);
                  });
              };
              if (v instanceof HistoryUp) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                      var n = (function () {
                          ...
                          throw new Error("Failed pattern match at Editor (line 156, column 15 - line 158, column 52): " + [ v1.inputMode.constructor.name ]);
                      })();
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v2) {
                          ...
                          if (v3 instanceof Data_Maybe.Just) {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v4) {
                                  ...
                                  $89.input = v3.value0.input;
                                  $89.inputMode = new SelectingHistory(n);
                                  return $89;
                              }))(function () {
                                  return handleAction(new CalculateTextAreaRows(v3.value0.input));
                              });
                          };
                          throw new Error("Failed pattern match at Editor (line 162, column 13 - line 167, column 59): " + [ v3.constructor.name ]);
                      });
                  });
              };
                          ...
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v2) {
                              ...
                              if (v3 instanceof Data_Maybe.Just) {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v4) {
                                      ...
                                      $106.inputMode = SelectingHistory.create(v1.inputMode.value0 - 1 | 0);
                                      return $106;
                                  }))(function () {
                                      return handleAction(new CalculateTextAreaRows(v3.value0.input));
                                  });
                              };
                              throw new Error("Failed pattern match at Editor (line 176, column 11 - line 180, column 57): " + [ v3.constructor.name ]);
                          });
                      };
                      throw new Error("Failed pattern match at Editor (line 171, column 7 - line 180, column 57): " + [ v1.inputMode.constructor.name ]);
                  });
              };
              ...
              if (v instanceof FocusById) {
                  return Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(function __do() {
                      ...
                      throw new Error("Failed pattern match at Editor (line 185, column 9 - line 187, column 31): " + [ v2.constructor.name ]);
                  });
              };
              throw new Error("Failed pattern match at Editor (line 103, column 18 - line 187, column 31): " + [ v.constructor.name ]);
          };
      })();
