...
(function($PS) {
  ...
  var transforms = (function () {
      var $26 = CSS_Stylesheet.key(CSS_Property.valValue)(CSS_String.fromString(CSS_Property.isStringKey)("transform"));
      var $27 = CSS_Property.noCommas(valTransformation);
      return function ($28) {
          return $26($27($28));
      };
  })();                                                                                                               
...
(function($PS) {
  ...
  var exports = $PS["Control.Monad.Trampoline"];
...
(function($PS) {
  // Generated by purs version 0.13.4
  "use strict";
  $PS["Data.Display"] = $PS["Data.Display"] || {};
  var exports = $PS["Data.Display"];
...
(function($PS) {
  // Generated by purs version 0.13.4
  "use strict";
  $PS["UntypedLambda.Core.Term"] = $PS["UntypedLambda.Core.Term"] || {};
  var exports = $PS["UntypedLambda.Core.Term"];
  var Data_Display = $PS["Data.Display"];
  var Data_Eq = $PS["Data.Eq"];
  var Data_Function = $PS["Data.Function"];
  var Data_String_CodePoints = $PS["Data.String.CodePoints"];
  var Data_String_Common = $PS["Data.String.Common"];                
  var NFVariable = (function () {
      function NFVariable(value0) {
          this.value0 = value0;
      };
      NFVariable.create = function (value0) {
          return new NFVariable(value0);
      };
      return NFVariable;
  })();
  var NFLambdaAbstraction = (function () {
      function NFLambdaAbstraction(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      NFLambdaAbstraction.create = function (value0) {
          return function (value1) {
              return new NFLambdaAbstraction(value0, value1);
          };
      };
      return NFLambdaAbstraction;
  })();
  var NFApplication = (function () {
      function NFApplication(value0) {
          this.value0 = value0;
      };
      NFApplication.create = function (value0) {
          return new NFApplication(value0);
      };
      return NFApplication;
  })();
  var NFIdentApp = (function () {
      function NFIdentApp(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      NFIdentApp.create = function (value0) {
          return function (value1) {
              return new NFIdentApp(value0, value1);
          };
      };
      return NFIdentApp;
  })();
  var NFAppApp = (function () {
      function NFAppApp(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      NFAppApp.create = function (value0) {
          return function (value1) {
              return new NFAppApp(value0, value1);
          };
      };
      return NFAppApp;
  })();
  ...
  var LambdaAbstraction = (function () {
      function LambdaAbstraction(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      LambdaAbstraction.create = function (value0) {
          return function (value1) {
              return new LambdaAbstraction(value0, value1);
          };
      };
  ...
  var eqTerm = new Data_Eq.Eq(function (v) {
      return function (v1) {
          if (v instanceof Variable && v1 instanceof Variable) {
              return v.value0 === v1.value0;
          };
          if (v instanceof LambdaAbstraction && v1 instanceof LambdaAbstraction) {
              return v.value0 === v1.value0 && Data_Eq.eq(eqTerm)(v.value1)(v1.value1);
          };
          if (v instanceof Application && v1 instanceof Application) {
              return Data_Eq.eq(eqTerm)(v.value0)(v1.value0) && Data_Eq.eq(eqTerm)(v.value1)(v1.value1);
          };
          return false;
      };
  });
  var displayTerm = new Data_Display.Display((function () {
      var paren = function (x) {
          return Data_String_Common.joinWith(x)([ "(", ")" ]);
      };
      return function (v) {
          if (v instanceof Variable) {
              return v.value0;
          };
          if (v instanceof LambdaAbstraction && v.value1 instanceof LambdaAbstraction) {
              return "\u03bb" + (v.value0 + (" " + Data_String_CodePoints.drop(1)(Data_Display.display(displayTerm)(v.value1))));
          };
          if (v instanceof LambdaAbstraction) {
              return "\u03bb" + (v.value0 + ("." + Data_Display.display(displayTerm)(v.value1)));
          };
          if (v instanceof Application) {
              return Data_String_Common.joinWith(" ")([ (function () {
                  ...
                  if (v.value0 instanceof LambdaAbstraction) {
                      return paren(Data_Display.display(displayTerm)(v.value0));
                  };
                  if (v.value0 instanceof Application) {
                      return Data_Display.display(displayTerm)(v.value0);
                  };
                  throw new Error("Failed pattern match at UntypedLambda.Core.Term (line 42, column 11 - line 47, column 49): " + [ v.value0.constructor.name ]);
              })(), (function () {
                  if (v.value1 instanceof Variable) {
                      return v.value1.value0;
                  };
                  if (v.value1 instanceof LambdaAbstraction) {
                      return paren(Data_Display.display(displayTerm)(v.value1));
                  };
                  if (v.value1 instanceof Application) {
                      return paren(Data_Display.display(displayTerm)(v.value1));
                  };
                  throw new Error("Failed pattern match at UntypedLambda.Core.Term (line 48, column 11 - line 54, column 57): " + [ v.value1.constructor.name ]);
              })() ]);
          };
          throw new Error("Failed pattern match at UntypedLambda.Core.Term (line 35, column 13 - line 55, column 10): " + [ v.constructor.name ]);
      };
  })());
  var asTerm = function (v) {
      if (v instanceof NFVariable) {
          return new Variable(v.value0);
      };
      if (v instanceof NFLambdaAbstraction) {
          return LambdaAbstraction.create(v.value0)(asTerm(v.value1));
      };
      if (v instanceof NFApplication && v.value0 instanceof NFIdentApp) {
          return Application.create(new Variable(v.value0.value0))(asTerm(v.value0.value1));
      };
      if (v instanceof NFApplication && v.value0 instanceof NFAppApp) {
          return Data_Function.on(Application.create)(asTerm)(new NFApplication(v.value0.value0))(v.value0.value1);
      };
      throw new Error("Failed pattern match at UntypedLambda.Core.Term (line 91, column 1 - line 91, column 29): " + [ v.constructor.name ]);
  };
  var displayNormalForm = new Data_Display.Display(function (nomalForm) {
      return Data_Display.display(displayTerm)(asTerm(nomalForm));
  });
  exports["Variable"] = Variable;
  exports["LambdaAbstraction"] = LambdaAbstraction;
  exports["Application"] = Application;
  exports["NFVariable"] = NFVariable;
  exports["NFLambdaAbstraction"] = NFLambdaAbstraction;
  exports["NFApplication"] = NFApplication;
  exports["NFIdentApp"] = NFIdentApp;
  exports["NFAppApp"] = NFAppApp;
  exports["asTerm"] = asTerm;
  exports["eqTerm"] = eqTerm;
  exports["displayTerm"] = displayTerm;
  exports["displayNormalForm"] = displayNormalForm;
})(PS);
(function($PS) {
  // Generated by purs version 0.13.4
  "use strict";
...
(function($PS) {
  // Generated by purs version 0.13.4
  "use strict";
  $PS["UntypedLambda.Core.Evaluator"] = $PS["UntypedLambda.Core.Evaluator"] || {};
  var exports = $PS["UntypedLambda.Core.Evaluator"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Bind = $PS["Control.Bind"];
  var Control_Monad_Free = $PS["Control.Monad.Free"];
  var Data_Array = $PS["Data.Array"];
  ...
  var Data_Functor = $PS["Data.Functor"];
  var Data_Int = $PS["Data.Int"];
  var UntypedLambda_Core_Term = $PS["UntypedLambda.Core.Term"];                
  var Substitution = (function () {
      function Substitution(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      Substitution.create = function (value0) {
          return function (value1) {
              return new Substitution(value0, value1);
          };
      };
      return Substitution;
  })();
  var withEnvironment = function (env) {
      return function (term) {
          var nomalForms = Data_Functor.map(Data_Functor.functorArray)(function (v) {
              return UntypedLambda_Core_Term.asTerm(v.value1);
          })(env);
          var names = Data_Functor.map(Data_Functor.functorArray)(function (v) {
              return v.value0;
          })(env);
          return Data_Foldable.foldl(Data_Foldable.foldableArray)(function (tm) {
              return function (nomalForm) {
                  return new UntypedLambda_Core_Term.Application(tm, nomalForm);
              };
          })(Data_Foldable.foldr(Data_Foldable.foldableArray)(function (name) {
              return function (tm) {
                  return new UntypedLambda_Core_Term.LambdaAbstraction(name, tm);
              };
          })(term)(names))(nomalForms);
      };
  };
  var freeVariables = function (v) {
      if (v instanceof UntypedLambda_Core_Term.Variable) {
          return [ v.value0 ];
      };
      if (v instanceof UntypedLambda_Core_Term.LambdaAbstraction) {
          return Data_Array.filter(Data_Eq.notEq(Data_Eq.eqString)(v.value0))(freeVariables(v.value1));
      };
      if (v instanceof UntypedLambda_Core_Term.Application) {
          return Data_Function.on(Data_Array.union(Data_Eq.eqString))(freeVariables)(v.value0)(v.value1);
      };
      throw new Error("Failed pattern match at UntypedLambda.Core.Evaluator (line 21, column 1 - line 21, column 42): " + [ v.constructor.name ]);
  };
  var alphaConversion = function (v) {
      return function (v1) {
          if (v1 instanceof UntypedLambda_Core_Term.Variable && v.value0 === v1.value0) {
              return v.value1;
          };
          var $$var = v1;
          if (v1 instanceof UntypedLambda_Core_Term.Variable) {
              return $$var;
          };
          if (v1 instanceof UntypedLambda_Core_Term.LambdaAbstraction && v.value0 === v1.value0) {
              return v1;
          };
          if (v1 instanceof UntypedLambda_Core_Term.LambdaAbstraction && Data_Foldable.notElem(Data_Foldable.foldableArray)(Data_Eq.eqString)(v1.value0)(freeVariables(v.value1))) {
              return UntypedLambda_Core_Term.LambdaAbstraction.create(v1.value0)(alphaConversion(v)(v1.value1));
          };
          if (v1 instanceof UntypedLambda_Core_Term.LambdaAbstraction) {
              var rename = function ($$var) {
                  return function (term) {
                      var freeVars = freeVariables(term);
                      var recur = function ($copy_n) {
                          var $tco_done = false;
                          var $tco_result;
                          function $tco_loop(n) {
                              var renamed = $$var + ("_" + Data_Int.toStringAs(Data_Int.decimal)(n));
                              var $42 = Data_Foldable.notElem(Data_Foldable.foldableArray)(Data_Eq.eqString)(renamed)(freeVars);
                              if ($42) {
                                  $tco_done = true;
                                  return renamed;
                              };
                      ...
                      var $43 = Data_Foldable.notElem(Data_Foldable.foldableArray)(Data_Eq.eqString)($$var)(freeVars);
                      if ($43) {
                          return $$var;
                      };
                      return recur(0);
              ...
              var newBound = rename(v1.value0)(v.value1);
              var newBody = alphaConversion(Substitution.create(v1.value0)(new UntypedLambda_Core_Term.Variable(newBound)))(v1.value1);
              var newLambda = new UntypedLambda_Core_Term.LambdaAbstraction(newBound, newBody);
              return alphaConversion(v)(newLambda);
          };
          if (v1 instanceof UntypedLambda_Core_Term.Application) {
              return Data_Function.on(UntypedLambda_Core_Term.Application.create)(alphaConversion(v))(v1.value0)(v1.value1);
          };
          throw new Error("Failed pattern match at UntypedLambda.Core.Evaluator (line 31, column 1 - line 31, column 48): " + [ v.constructor.name, v1.constructor.name ]);
      };
  };
  var betaReduction = function (v) {
      return function (arg) {
          if (v instanceof UntypedLambda_Core_Term.LambdaAbstraction) {
              return alphaConversion(new Substitution(v.value0, arg))(v.value1);
          };
          return new UntypedLambda_Core_Term.Application(v, arg);
      };
  };
  var callByValue = function (v) {
      if (v instanceof UntypedLambda_Core_Term.Variable) {
          return Control_Applicative.pure(Control_Monad_Free.freeApplicative)(new UntypedLambda_Core_Term.NFVariable(v.value0));
      };
      if (v instanceof UntypedLambda_Core_Term.LambdaAbstraction) {
          return Data_Functor.map(Control_Monad_Free.freeFunctor)(UntypedLambda_Core_Term.NFLambdaAbstraction.create(v.value0))(callByValue(v.value1));
      };
      if (v instanceof UntypedLambda_Core_Term.Application) {
          return Control_Bind.bind(Control_Monad_Free.freeBind)(callByValue(v.value0))(function (v1) {
              return Control_Bind.bind(Control_Monad_Free.freeBind)(callByValue(v.value1))(function (v2) {
                  if (v1 instanceof UntypedLambda_Core_Term.NFVariable) {
                      return Control_Applicative.pure(Control_Monad_Free.freeApplicative)(UntypedLambda_Core_Term.NFApplication.create(new UntypedLambda_Core_Term.NFIdentApp(v1.value0, v2)));
                  };
                  if (v1 instanceof UntypedLambda_Core_Term.NFLambdaAbstraction) {
                      return callByValue(Data_Function.on(betaReduction)(UntypedLambda_Core_Term.asTerm)(v1)(v2));
                  };
                  if (v1 instanceof UntypedLambda_Core_Term.NFApplication) {
                      return Control_Applicative.pure(Control_Monad_Free.freeApplicative)(UntypedLambda_Core_Term.NFApplication.create(new UntypedLambda_Core_Term.NFAppApp(v1.value0, v2)));
                  };
                  throw new Error("Failed pattern match at UntypedLambda.Core.Evaluator (line 91, column 3 - line 94, column 71): " + [ v1.constructor.name ]);
              });
          });
      };
      throw new Error("Failed pattern match at UntypedLambda.Core.Evaluator (line 83, column 1 - line 83, column 45): " + [ v.constructor.name ]);
  };
...
(function($PS) {
  // Generated by purs version 0.13.4
  "use strict";
  $PS["UntypedLambda.Core.Parser"] = $PS["UntypedLambda.Core.Parser"] || {};
  var exports = $PS["UntypedLambda.Core.Parser"];
  var Control_Alt = $PS["Control.Alt"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Apply = $PS["Control.Apply"];
  var Control_Bind = $PS["Control.Bind"];
  ...
  var UntypedLambda_Core_Term = $PS["UntypedLambda.Core.Term"];                
  var spaces1 = function (dictMonad) {
      return Data_Array.some(Text_Parsing_Parser.alternativeParserT(dictMonad))(Text_Parsing_Parser.lazyParserT)(Data_Functor["void"](Text_Parsing_Parser.functorParserT(((dictMonad.Bind1()).Apply0()).Functor0()))(Text_Parsing_Parser_Token.space(dictMonad)));
  };
  var spaces = function (dictMonad) {
      return Data_Array.many(Text_Parsing_Parser.alternativeParserT(dictMonad))(Text_Parsing_Parser.lazyParserT)(Data_Functor["void"](Text_Parsing_Parser.functorParserT(((dictMonad.Bind1()).Apply0()).Functor0()))(Text_Parsing_Parser_Token.space(dictMonad)));
  };
  var parens = function (dictMonad) {
      return Text_Parsing_Parser_Combinators.between(dictMonad)(Control_Apply.applyFirst(Text_Parsing_Parser.applyParserT(dictMonad))(Text_Parsing_Parser_String.string(Text_Parsing_Parser_String.stringLikeString)(dictMonad)("("))(spaces(dictMonad)))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(dictMonad))(spaces(dictMonad))(Text_Parsing_Parser_String.string(Text_Parsing_Parser_String.stringLikeString)(dictMonad)(")")));
  };
  var identifier = Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(Data_String_CodeUnits.fromCharArray)(Data_Array.some(Text_Parsing_Parser.alternativeParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser.lazyParserT)(Text_Parsing_Parser_String.satisfy(Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)(function (chr) {
      return Data_Char_Unicode.isAlphaNum(chr) && chr !== "\u03bb" || Data_Foldable.elem(Data_Foldable.foldableArray)(Data_Eq.eqChar)(chr)([ "!", "@", "#", "$", "%", "^", "&", "*", "-", "_", "+", "|", "<", ">", "/", "?" ]);
  })));
  var term = (function () {
      var variable = Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(UntypedLambda_Core_Term.Variable.create)(identifier);
      var lambdaAbstraction = function (tm) {
          return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(Control_Apply.applyFirst(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser_String.string(Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)("\u03bb"))(Text_Parsing_Parser_String.string(Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)("\\")))(spaces(Data_Identity.monadIdentity)))(function (v) {
              return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(identifier)(function (v1) {
                  return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(spaces1(Data_Identity.monadIdentity))(Text_Parsing_Parser_Combinators.sepEndBy(Data_Identity.monadIdentity)(identifier)(spaces1(Data_Identity.monadIdentity))))(Control_Applicative.pure(Text_Parsing_Parser.applicativeParserT(Data_Identity.monadIdentity))(Data_List_Types.Nil.value)))(function (v2) {
                      return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(Control_Apply.applyFirst(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(spaces(Data_Identity.monadIdentity))(Text_Parsing_Parser_String.string(Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)(".")))(spaces(Data_Identity.monadIdentity)))(function (v3) {
                          return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(tm)(function (v4) {
                              return Control_Applicative.pure(Text_Parsing_Parser.applicativeParserT(Data_Identity.monadIdentity))(Data_Foldable.foldr(Data_List_Types.foldableList)(UntypedLambda_Core_Term.LambdaAbstraction.create)(v4)(new Data_List_Types.Cons(v1, v2)));
                          });
                      });
                  });
              });
      ...
      var nonApplication = function (tm) {
          return Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(parens(Data_Identity.monadIdentity)(tm))(variable))(lambdaAbstraction(tm));
      };
      var application = Control_Lazy.fix(Text_Parsing_Parser.lazyParserT)(function (tm) {
          return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(nonApplication(tm))(function (v) {
              return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(spaces(Data_Identity.monadIdentity))(Text_Parsing_Parser_Combinators.sepEndBy(Data_Identity.monadIdentity)(nonApplication(tm))(spaces1(Data_Identity.monadIdentity))))(Control_Applicative.pure(Text_Parsing_Parser.applicativeParserT(Data_Identity.monadIdentity))(Data_List_Types.Nil.value)))(function (v1) {
                  return Control_Applicative.pure(Text_Parsing_Parser.applicativeParserT(Data_Identity.monadIdentity))((function () {
                      var $15 = Data_Eq.eq(Data_List_Types.eqList(UntypedLambda_Core_Term.eqTerm))(v1)(Data_List_Types.Nil.value);
                      if ($15) {
                          return v;
                      };
                      return Data_Foldable.foldl(Data_List_Types.foldableList)(UntypedLambda_Core_Term.Application.create)(v)(v1);
                  })());
              });
          });
      });
      return Control_Apply.applyFirst(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(spaces(Data_Identity.monadIdentity))(application))(Text_Parsing_Parser_String.eof(Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity));
  })();
  exports["term"] = term;
...
(function($PS) {
  // Generated by purs version 0.13.4
  "use strict";
  $PS["UntypedLambda.Core.Prime"] = $PS["UntypedLambda.Core.Prime"] || {};
  var exports = $PS["UntypedLambda.Core.Prime"];
...
(function($PS) {
  ...
  var exports = $PS["UntypedLambda.REPL"];
  var Control_Alt = $PS["Control.Alt"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Apply = $PS["Control.Apply"];
  var Control_Bind = $PS["Control.Bind"];
  ...
  var Text_Parsing_Parser_Combinators = $PS["Text.Parsing.Parser.Combinators"];
  var Text_Parsing_Parser_String = $PS["Text.Parsing.Parser.String"];
  var UntypedLambda_Core_Evaluator = $PS["UntypedLambda.Core.Evaluator"];
  var UntypedLambda_Core_Parser = $PS["UntypedLambda.Core.Parser"];
  var UntypedLambda_Core_Prime = $PS["UntypedLambda.Core.Prime"];
  var UntypedLambda_Core_Term = $PS["UntypedLambda.Core.Term"];                
  var Term = (function () {
      function Term(value0) {
          this.value0 = value0;
      };
      Term.create = function (value0) {
          return new Term(value0);
      };
      return Term;
  })();
  ...
  var StartMultiline = (function () {
      function StartMultiline() {

      };
      StartMultiline.value = new StartMultiline();
      return StartMultiline;
  })();
  var EndMultiline = (function () {
      function EndMultiline() {

      };
      EndMultiline.value = new EndMultiline();
      return EndMultiline;
  })();
  var Help = (function () {
      function Help() {
  ...
  var $$eval = function ($copy_input) {
      return function ($copy_v) {
          ...
          var $tco_done = false;
          var $tco_result;
          function $tco_loop(input, v) {
              if (v.inputMode instanceof Multiline) {
                  var endMultiline = Data_Functor.voidRight(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(EndMultiline.value)(Control_Apply.applyFirst(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Control_Apply.applyFirst(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(UntypedLambda_Core_Parser.spaces(Data_Identity.monadIdentity))(Text_Parsing_Parser_String.string(Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)(".end")))(UntypedLambda_Core_Parser.spaces(Data_Identity.monadIdentity)))(Text_Parsing_Parser_String.eof(Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)));
                  var v1 = Text_Parsing_Parser.runParser(input)(endMultiline);
                  if (v1 instanceof Data_Either.Right) {
                      $tco_var_input = Data_String_Common.joinWith("\x0a")(v.inputPool);
                      $copy_v = REPL({
                          env: v.env,
                          history: v.history,
                  ...
                  throw new Error("Failed pattern match at UntypedLambda.REPL (line 84, column 82 - line 91, column 63): " + [ v1.constructor.name ]);
              };
              var startMultiline = Data_Functor.voidRight(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(StartMultiline.value)(Control_Apply.applyFirst(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Control_Apply.applyFirst(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(UntypedLambda_Core_Parser.spaces(Data_Identity.monadIdentity))(Text_Parsing_Parser_String.string(Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)(".multi")))(UntypedLambda_Core_Parser.spaces(Data_Identity.monadIdentity)))(Text_Parsing_Parser_String.eof(Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)));
              var help = Data_Functor.voidRight(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(Help.value)(Control_Apply.applyFirst(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Control_Apply.applyFirst(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(UntypedLambda_Core_Parser.spaces(Data_Identity.monadIdentity))(Text_Parsing_Parser_String.string(Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)(".help")))(UntypedLambda_Core_Parser.spaces(Data_Identity.monadIdentity)))(Text_Parsing_Parser_String.eof(Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)));
              var endMultiline = Data_Functor.voidRight(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(EndMultiline.value)(Control_Apply.applyFirst(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Control_Apply.applyFirst(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(UntypedLambda_Core_Parser.spaces(Data_Identity.monadIdentity))(Text_Parsing_Parser_String.string(Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)(".end")))(UntypedLambda_Core_Parser.spaces(Data_Identity.monadIdentity)))(Text_Parsing_Parser_String.eof(Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)));
              var define = Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(UntypedLambda_Core_Parser.spaces(Data_Identity.monadIdentity))(function (v1) {
                  return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(UntypedLambda_Core_Parser.identifier)(function (v2) {
                      return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(Control_Apply.applyFirst(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(UntypedLambda_Core_Parser.spaces(Data_Identity.monadIdentity))(Text_Parsing_Parser_String.string(Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)("=")))(UntypedLambda_Core_Parser.spaces(Data_Identity.monadIdentity)))(function (v3) {
                          return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(UntypedLambda_Core_Parser.term)(function (v4) {
                              return Control_Applicative.pure(Text_Parsing_Parser.applicativeParserT(Data_Identity.monadIdentity))(new Definition(v2, v4));
                          });
                      });
                  });
              });
              var _term = Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(Term.create)(UntypedLambda_Core_Parser.term);
              var parser = Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser_Combinators["try"](Data_Identity.monadIdentity)(startMultiline))(Text_Parsing_Parser_Combinators["try"](Data_Identity.monadIdentity)(endMultiline)))(Text_Parsing_Parser_Combinators["try"](Data_Identity.monadIdentity)(help)))(Text_Parsing_Parser_Combinators["try"](Data_Identity.monadIdentity)(define)))(_term);
              var v1 = Text_Parsing_Parser.runParser(input)(parser);
              if (v1 instanceof Data_Either.Right && v1.value0 instanceof StartMultiline) {
                  $tco_done = true;
                  return REPL({
                      env: v.env,
                      ...
                      inputMode: Multiline.value,
                      inputPool: v.inputPool
                  });
              };
              if (v1 instanceof Data_Either.Right && v1.value0 instanceof EndMultiline) {
                  $tco_done = true;
                  return REPL({
                      env: v.env,
                      history: Data_Array.snoc(v.history)({
                          input: input,
                          output: new Data_Maybe.Just("Error: `.end` can only be used in a multiline mode.")
                      }),
                      inputMode: v.inputMode,
                      inputPool: v.inputPool
                  });
              };
              if (v1 instanceof Data_Either.Right && v1.value0 instanceof Help) {
                  $tco_done = true;
                  return REPL({
                      env: v.env,
                      history: Data_Array.snoc(v.history)({
                          input: input,
                          output: new Data_Maybe.Just("The following commands are available.\x0a\x0a.multi                        Start a multiline mode\x0a.end                          End a multiline mode\x0a.help                         Show this help menu\x0a\x0a<identifier> = <term>   Add a new binding into the Environment. An term `M` under the Environment `a = b` is equivalent to ((\u03bba.M) b)")
                      }),
                      inputMode: v.inputMode,
                      inputPool: v.inputPool
                  });
              };
              if (v1 instanceof Data_Either.Right && v1.value0 instanceof Definition) {
                  var normalForm = Control_Monad_Trampoline.runTrampoline(UntypedLambda_Core_Evaluator.callByValue(UntypedLambda_Core_Evaluator.withEnvironment(v.env)(v1.value0.value1)));
                  $tco_done = true;
                  return REPL({
                      env: Data_Array.snoc(v.env)(new Data_Tuple.Tuple(v1.value0.value0, normalForm)),
                      history: Data_Array.snoc(v.history)({
                          input: input,
                          output: Data_Maybe.Just.create(Data_Display.display(UntypedLambda_Core_Term.displayTerm)(UntypedLambda_Core_Term.asTerm(normalForm)))
                      }),
                      inputMode: v.inputMode,
                      inputPool: v.inputPool
                  });
              };
              if (v1 instanceof Data_Either.Right && v1.value0 instanceof Term) {
                  $tco_done = true;
                  return REPL({
                      env: v.env,
                      history: Data_Array.snoc(v.history)({
                          input: input,
                          output: Data_Maybe.Just.create(Data_Display.display(UntypedLambda_Core_Term.displayTerm)(UntypedLambda_Core_Term.asTerm(Control_Monad_Trampoline.runTrampoline(UntypedLambda_Core_Evaluator.callByValue(UntypedLambda_Core_Evaluator.withEnvironment(v.env)(v1.value0.value0))))))
                      }),
                      inputMode: v.inputMode,
                      inputPool: v.inputPool
                  });
              ...
              if (v1 instanceof Data_Either.Left) {
                  ...
                  var v2 = Text_Parsing_Parser.parseErrorPosition(v1.value0);
                  var inputLines = Control_Bind.bind(Control_Bind.bindArray)(Data_String_Common.split("\x0a")(input))(function (v3) {
                      return Data_String_Common.split("\x0d`")(v3);
                  });
                  var nearStr = Data_Maybe.maybe("")(Data_String_CodePoints.take(v2.column))(Data_Array.index(inputLines)(v2.line - 1 | 0));
                  $tco_done = true;
                  return REPL({
                      env: v.env,
                      history: Data_Array.snoc(v.history)({
                          input: input,
                          output: Data_Maybe.Just.create("Error: " + (msg + (" near '" + (nearStr + "'."))))
                      }),
                      inputMode: v.inputMode,
                      inputPool: v.inputPool
                  });
              };
              throw new Error("Failed pattern match at UntypedLambda.REPL (line 95, column 26 - line 168, column 14): " + [ v1.constructor.name ]);
          };
          while (!$tco_done) {
  ...
  var init = (function () {
      var v = Data_Foldable.foldl(Data_Foldable.foldableArray)(Data_Function.flip($$eval))({
          ...
          inputMode: Singleline.value,
          inputPool: [  ]
      })(Data_String_Common.split("\x0a")(UntypedLambda_Core_Prime.prime));
      return {
          env: v.env,
          history: [  ],
          inputMode: Singleline.value,
  ...
  exports["init"] = init;
  exports["eval"] = $$eval;
  exports["newtypeREPL"] = newtypeREPL;
})(PS);
(function(exports) {
  "use strict";
...
})(PS["Web.Event.EventTarget.Extra"] = PS["Web.Event.EventTarget.Extra"] || {});
(function($PS) {
  // Generated by purs version 0.13.4
  "use strict";
  $PS["Web.Event.EventTarget.Extra"] = $PS["Web.Event.EventTarget.Extra"] || {};
  var exports = $PS["Web.Event.EventTarget.Extra"];
  var $foreign = $PS["Web.Event.EventTarget.Extra"];
  exports["addEventListenerOnce"] = $foreign.addEventListenerOnce;
})(PS);
(function(exports) {
  "use strict";
...
})(PS["Web.HTML.CSSStyleDeclaration"] = PS["Web.HTML.CSSStyleDeclaration"] || {});
(function($PS) {
  // Generated by purs version 0.13.4
  "use strict";
  $PS["Web.HTML.CSSStyleDeclaration"] = $PS["Web.HTML.CSSStyleDeclaration"] || {};
  var exports = $PS["Web.HTML.CSSStyleDeclaration"];
  var $foreign = $PS["Web.HTML.CSSStyleDeclaration"];
  exports["getComputedStyle"] = $foreign.getComputedStyle;
  exports["lineHeight"] = $foreign.lineHeight;
})(PS);
(function(exports) {
  "use strict";
...
})(PS["Web.HTML.HTMLDocument.ExecCommand"] = PS["Web.HTML.HTMLDocument.ExecCommand"] || {});
(function($PS) {
  // Generated by purs version 0.13.4
  "use strict";
  $PS["Web.HTML.HTMLDocument.ExecCommand"] = $PS["Web.HTML.HTMLDocument.ExecCommand"] || {};
  var exports = $PS["Web.HTML.HTMLDocument.ExecCommand"];
  var $foreign = $PS["Web.HTML.HTMLDocument.ExecCommand"];
  var copy = "copy";
  exports["copy"] = copy;
  exports["execCommand"] = $foreign.execCommand;
})(PS);
(function(exports) {
  "use strict";
...
(function($PS) {
  ...
  var UntypedLambda_Core_Term = $PS["UntypedLambda.Core.Term"];
  var UntypedLambda_REPL = $PS["UntypedLambda.REPL"];
  ...
  var Web_Event_Event = $PS["Web.Event.Event"];
  var Web_Event_EventTarget = $PS["Web.Event.EventTarget"];
  var Web_Event_EventTarget_Extra = $PS["Web.Event.EventTarget.Extra"];
  var Web_HTML = $PS["Web.HTML"];
  var Web_HTML_CSSStyleDeclaration = $PS["Web.HTML.CSSStyleDeclaration"];
  var Web_HTML_Event_DataTransfer = $PS["Web.HTML.Event.DataTransfer"];
  var Web_HTML_Event_EventTypes = $PS["Web.HTML.Event.EventTypes"];
  var Web_HTML_HTMLDocument = $PS["Web.HTML.HTMLDocument"];
  var Web_HTML_HTMLDocument_ExecCommand = $PS["Web.HTML.HTMLDocument.ExecCommand"];
  var Web_HTML_HTMLElement = $PS["Web.HTML.HTMLElement"];
  var Web_HTML_Window = $PS["Web.HTML.Window"];
  ...
  var WithPrompt = (function () {
      function WithPrompt() {

      };
      WithPrompt.value = new WithPrompt();
      return WithPrompt;
  })();
  var WithPromptAndLoading = (function () {
      function WithPromptAndLoading() {

      };
      WithPromptAndLoading.value = new WithPromptAndLoading();
      return WithPromptAndLoading;
  })();
  var WithoutPrompt = (function () {
      function WithoutPrompt() {

      };
      WithoutPrompt.value = new WithoutPrompt();
  ...
  var Inputting = (function () {
      ...
      Inputting.value = new Inputting();
      return Inputting;
  })();
  var SelectingHistory = (function () {
      function SelectingHistory(value0) {
          this.value0 = value0;
      };
      SelectingHistory.create = function (value0) {
          return new SelectingHistory(value0);
      };
      return SelectingHistory;
  })();
  var Evaluating = (function () {
      function Evaluating() {

      };
      Evaluating.value = new Evaluating();
      return Evaluating;
  })();
  var Dummy = (function () {
  ...
  var TextArea = (function () {
      function TextArea(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      TextArea.create = function (value0) {
          return function (value1) {
              return new TextArea(value0, value1);
          };
      };
      return TextArea;
  })();
  var TextAreaId = (function () {
      function TextAreaId() {

      };
      TextAreaId.value = new TextAreaId();
      return TextAreaId;
  })();
  var BehindTextAreaId = (function () {
      function BehindTextAreaId() {

      };
      BehindTextAreaId.value = new BehindTextAreaId();
      return BehindTextAreaId;
  })();
  var Composition = (function () {
      function Composition(value0) {
          this.value0 = value0;
      };
      Composition.create = function (value0) {
          return new Composition(value0);
      };
      return Composition;
  })();
  ...
  var FocusById = (function () {
      function FocusById(value0) {
          this.value0 = value0;
      };
      FocusById.create = function (value0) {
          return new FocusById(value0);
      };
      return FocusById;
  })();
  var DisplaySelectOrCopyPopup = (function () {
      function DisplaySelectOrCopyPopup(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      DisplaySelectOrCopyPopup.create = function (value0) {
          return function (value1) {
              return new DisplaySelectOrCopyPopup(value0, value1);
          };
      };
      return DisplaySelectOrCopyPopup;
  })();
  var HiddenSelectOrCopyPopup = (function () {
      function HiddenSelectOrCopyPopup() {

      };
      HiddenSelectOrCopyPopup.value = new HiddenSelectOrCopyPopup();
      return HiddenSelectOrCopyPopup;
  })();
  var Select = (function () {
  ...
  var getString = function (v) {
      if (v instanceof TextAreaId) {
          return "repl-input-textarea-id";
      };
      if (v instanceof BehindTextAreaId) {
          return "behind-textarea-id";
      };
      throw new Error("Failed pattern match at Main (line 92, column 1 - line 92, column 26): " + [ v.constructor.name ]);
  };
  var main = (function () {
      var render = function (state) {
          var inputLine = function (classes) {
              return function (mode) {
                  var prefix = function (mode1) {
                      return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ "flex", "justify-end" ])((function () {
                          if (mode1 instanceof WithoutPrompt) {
                              return [ "invisible" ];
                          };
                          return [  ];
                      })())) ])([ Halogen_HTML_Elements.span([ Halogen_HTML_Properties.classes([ "mr-1" ]) ])([ Halogen_HTML_Core.text(">") ]) ]);
                  };
                  var postfix = function (mode1) {
                      return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ "z-20", "w-6", "h-6", "flex", "items-center", "justify-center" ])((function () {
                          if (mode1 instanceof WithPromptAndLoading) {
                              return [  ];
                          };
                          return [ "invisible" ];
                      })())) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "w-4", "h-4", "rounded-full", "border-gray-700", "border-r-2", "border-b-2" ]), Halogen_HTML_CSS.style(CSS_Animation.animation(CSS_Animation.AnimationName(CSS_Property.value(CSS_Property.valString)("one-rotation")))(CSS_Time.sec(1.2))(CSS_Transition.linear)(CSS_Time.sec(0.0))(CSS_Animation.infinite)(CSS_Animation.normalAnimationDirection)(CSS_Animation.forwards)) ])([  ]) ]);
                  };
                  if (mode instanceof Dummy) {
                      return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ "flex", "font-mono" ])(classes)) ])([ prefix(WithPrompt.value), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "w-full", "bg-gray-800" ]) ])([ mode.value0 ]), postfix(WithPrompt.value) ]);
                  };
                  if (mode instanceof TextArea) {
                      return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ "flex", "font-mono" ])(classes)) ])([ prefix(mode.value0), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "flex", "relative", "w-full" ]) ])([ Halogen_HTML_Elements.textarea([ Halogen_HTML_Properties.id_(getString(TextAreaId.value)), Halogen_HTML_Properties.disabled((function () {
                          if (mode.value1 instanceof Evaluating) {
                              return true;
                          };
                          return false;
                      })()), Halogen_HTML_Properties.classes([ "w-full", "apperance-none", "focus:outline-none", "bg-gray-800", "resize-none", "overflow-y-hidden", "z-10", "break-all" ]), Halogen_HTML_Properties.rows(state.textAreaRows), Halogen_HTML_Properties.autofocus(true), Halogen_HTML_Properties.value(state.input), Halogen_HTML_Events.onKeyDown(function ($163) {
                          return Data_Maybe.Just.create(KeyDown.create($163));
                      }), Halogen_HTML_Events.onKeyUp(function ($164) {
                          return Data_Maybe.Just.create(KeyUp.create($164));
                      }), Halogen_HTML_Events.onValueInput(function ($165) {
                          return Data_Maybe.Just.create(Input.create($165));
                      }) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.id_(getString(BehindTextAreaId.value)), Halogen_HTML_Properties.classes([ "absolute", "w-full", "break-all", "bg-gray-900", "text-gray-900", "whitespace-pre-wrap" ]) ])([ Halogen_HTML_Core.text(state.input) ]) ]), postfix(mode.value0) ]);
                  };
                  throw new Error("Failed pattern match at Main (line 582, column 30 - line 636, column 12): " + [ mode.constructor.name ]);
              };
          };
          var repl = Data_Newtype.unwrap(UntypedLambda_REPL.newtypeREPL)(state.repl);
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "min-w-full", "min-h-full", "bg-gray-900", "text-white", "text-base", "font-sans" ]), Halogen_HTML_Events.onClick(Data_Function["const"](new Data_Maybe.Just(HiddenSelectOrCopyPopup.value))) ])([ Halogen_HTML_Elements.header([ Halogen_HTML_Properties.classes([ "flex", "justify-between", "py-4" ]) ])([ Halogen_HTML_Elements.h1([ Halogen_HTML_Properties.classes([ "mx-6", "text-3xl" ]) ])([ Halogen_HTML_Elements.span([ Halogen_HTML_Properties.classes([ "inline-block", "w-12", "h-12", "rounded-full", "bg-indigo-800", "align-middle", "text-center", "font-black", "font-mono" ]) ])([ Halogen_HTML_Elements.span([ Halogen_HTML_Properties.classes([ "inline-block", "pt-1" ]) ])([ Halogen_HTML_Core.text("\u03bb") ]) ]) ]), Halogen_HTML_Elements.nav([ Halogen_HTML_Properties.classes([ "mx-2" ]) ])([ Halogen_HTML_Elements.ul([ Halogen_HTML_Properties.classes([ "flex", "justify-end" ]) ])([ Halogen_HTML_Elements.li_([ Halogen_HTML_Elements.a([ Halogen_HTML_Properties.target("_blank"), Halogen_HTML_Properties.href("https://github.com/utatatata/untyped-lambda-calculus") ])([ Halogen_HTML_Core.text("GitHub") ]) ]) ]) ]) ]), Halogen_HTML_Elements.main([ Halogen_HTML_Properties.classes([ "mx-4", "w-auto", "border-2", "border-gray-800", "rounded", "p-2" ]) ])([ Halogen_HTML_Elements.ul([ Halogen_HTML_Properties.classes([ "flex", "mb-5", "text-gray-400" ]) ])((function () {
              var active = [ "text-gray-700" ];
              return [ Halogen_HTML_Elements.li([ Halogen_HTML_Properties.classes(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ "mr-5" ])((function () {
                  if (state.tab instanceof REPL) {
                      return active;
                  };
                  return [  ];
              })())) ])([ Halogen_HTML_Elements.a([ Halogen_HTML_Properties.classes([ "cursor-default" ]), Halogen_HTML_Events.onClick(function (me) {
                  var e = Web_UIEvent_MouseEvent.toEvent(me);
                  return Data_Maybe.Just.create(new Composition([ new PreventDefault(e), new StopPropagation(e), new SwitchTab(REPL.value), new FocusById(TextAreaId.value) ]));
              }) ])([ Halogen_HTML_Core.text("REPL") ]) ]), Halogen_HTML_Elements.li([ Halogen_HTML_Properties.classes(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ "mr-5" ])((function () {
                  if (state.tab instanceof Environment) {
                      return active;
                  };
                  return [  ];
              })())) ])([ Halogen_HTML_Elements.a([ Halogen_HTML_Properties.classes([ "cursor-default" ]), Halogen_HTML_Events.onClick(function (me) {
                  var e = Web_UIEvent_MouseEvent.toEvent(me);
                  return Data_Maybe.Just.create(new Composition([ new PreventDefault(e), new StopPropagation(e), new SwitchTab(Environment.value) ]));
              }) ])([ Halogen_HTML_Core.text("Environment") ]) ]), Halogen_HTML_Elements.li([ Halogen_HTML_Properties.classes((function () {
                  if (state.tab instanceof Help) {
                      return active;
                  };
                  return [  ];
              })()) ])([ Halogen_HTML_Elements.a([ Halogen_HTML_Properties.classes([ "cursor-default" ]), Halogen_HTML_Events.onClick(function (me) {
                  var e = Web_UIEvent_MouseEvent.toEvent(me);
                  return Data_Maybe.Just.create(new Composition([ new PreventDefault(e), new StopPropagation(e), new SwitchTab(Help.value) ]));
              }) ])([ Halogen_HTML_Core.text("Help") ]) ]) ];
          })()), Halogen_HTML_Elements.section([ Halogen_HTML_Properties.classes((function () {
              if (state.tab instanceof REPL) {
                  return [  ];
              };
              return [ "hidden" ];
          })()) ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)((function () {
              if (state.popupState instanceof Hidden) {
                  return [  ];
              };
              if (state.popupState instanceof Display) {
                  return [ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "absolute", "flex", "flex-col", "z-30" ]), Halogen_HTML_CSS.style(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.left(CSS_Size.px(Data_Int.toNumber(state.popupState.value1.x - 30 | 0))))(function () {
                      return CSS_Geometry.top(CSS_Size.px(Data_Int.toNumber(state.popupState.value1.y - 60 | 0)));
                  })) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "flex", "bg-gray-900", "text-gray-400", "rounded", "border-2", "border-gray-800", "z-30" ]) ])([ Halogen_HTML_Elements.button([ Halogen_HTML_Properties.classes([ "appearance-none", "p-2", "border-r-2", "border-gray-800", "focus:bg-blue-600" ]), Halogen_HTML_Events.onClick(function (me) {
                      var e = Web_UIEvent_MouseEvent.toEvent(me);
                      return Data_Maybe.Just.create(new Composition([ new PreventDefault(e), new StopPropagation(e), new Select(state.popupState.value0) ]));
                  }) ])([ Halogen_HTML_Core.text("Select") ]), Halogen_HTML_Elements.button([ Halogen_HTML_Properties.classes([ "appearance-none", "p-2", "focus:bg-blue-600" ]), Halogen_HTML_Events.onClick(function (me) {
                      var e = Web_UIEvent_MouseEvent.toEvent(me);
                      return Data_Maybe.Just.create(new Composition([ new PreventDefault(e), new StopPropagation(e), new CopyToClipboard(state.popupState.value0) ]));
                  }) ])([ Halogen_HTML_Core.text("Copy") ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "bg-gray-800", "border-2", "border-gray-900", "w-5", "h-5" ]), Halogen_HTML_CSS.style(CSS_Transform.transforms([ CSS_Transform.translate(CSS_Size.em(1.3))(CSS_Size.em(-0.6)), CSS_Transform.rotate(CSS_Size.deg(-45.0)) ])) ])([  ]) ]) ];
              };
              throw new Error("Failed pattern match at Main (line 377, column 21 - line 447, column 26): " + [ state.popupState.constructor.name ]);
          })())([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "flex", "flex-col" ]) ])(Data_Functor.map(Data_Functor.functorArray)(function (v) {
              return Halogen_HTML_Elements.div_(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ inputLine([  ])(Dummy.create(Halogen_HTML_Elements.span([ Halogen_HTML_Properties.classes([ "inline-block", "w-full", "break-all", "whitespace-pre-wrap" ]), Halogen_HTML_Events.onClick(function (me) {
                  var e = Web_UIEvent_MouseEvent.toEvent(me);
                  return Data_Maybe.Just.create(new Composition([ new PreventDefault(e), new StopPropagation(e), new DisplaySelectOrCopyPopup(v.input, me) ]));
              }) ])([ Halogen_HTML_Core.text(v.input) ]))) ])((function () {
                  if (v.output instanceof Data_Maybe.Just) {
                      return [ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "mb-4", "break-all", "whitespace-pre-wrap", "font-mono" ]) ])([ Halogen_HTML_Core.text(v.output.value0) ]) ];
                  };
                  if (v.output instanceof Data_Maybe.Nothing) {
                      return [  ];
                  };
                  throw new Error("Failed pattern match at Main (line 468, column 32 - line 480, column 46): " + [ v.output.constructor.name ]);
              })()));
          })(repl.history)), inputLine((function () {
              if (repl.inputMode instanceof UntypedLambda_REPL.Singleline) {
                  return [ "hidden" ];
              };
              if (repl.inputMode instanceof UntypedLambda_REPL.Multiline) {
                  var $61 = Data_Eq.eq(Data_Eq.eqArray(Data_Eq.eqString))(repl.inputPool)([  ]);
                  if ($61) {
                      return [ "hidden" ];
                  };
                  return [  ];
              };
              throw new Error("Failed pattern match at Main (line 483, column 25 - line 489, column 33): " + [ repl.inputMode.constructor.name ]);
          })())(Dummy.create(Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "flex", "flex-col" ]) ])(Data_Functor.map(Data_Functor.functorArray)(function (input) {
              return Halogen_HTML_Elements.span([ Halogen_HTML_Properties.classes([ "break-all", "whitespace-pre-wrap" ]) ])([ Halogen_HTML_Core.text(input) ]);
          })(repl.inputPool)))), inputLine([  ])(new TextArea((function () {
              var $62 = {
                  sMode: state.inputMode,
                  rMode: repl.inputMode
              };
              if ($62.sMode instanceof Evaluating) {
                  return WithPromptAndLoading.value;
              };
              if ($62.rMode instanceof UntypedLambda_REPL.Singleline) {
                  return WithPrompt.value;
              };
              if ($62.rMode instanceof UntypedLambda_REPL.Multiline) {
                  var $67 = Data_Eq.eq(Data_Eq.eqArray(Data_Eq.eqString))(repl.inputPool)([  ]);
                  if ($67) {
                      return WithPrompt.value;
                  };
                  return WithoutPrompt.value;
              };
              throw new Error("Failed pattern match at Main (line 499, column 29 - line 506, column 48): " + [ $62.constructor.name ]);
          })(), state.inputMode)) ])), Halogen_HTML_Elements.section([ Halogen_HTML_Properties.classes((function () {
              if (state.tab instanceof Environment) {
                  return [  ];
              };
              return [ "hidden" ];
          })()) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "flex", "flex-col" ]) ])(Data_Functor.map(Data_Functor.functorArray)(function (v) {
              return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "break-all" ]) ])([ Halogen_HTML_Core.text(v.value0 + (" = " + Data_Display.display(UntypedLambda_Core_Term.displayNormalForm)(v.value1))) ]);
          })(repl.env)) ]), Halogen_HTML_Elements.section([ Halogen_HTML_Properties.classes((function () {
              if (state.tab instanceof Help) {
                  return [  ];
              };
              return [ "hidden" ];
          })()) ])([ Halogen_HTML_Elements.h2([ Halogen_HTML_Properties.classes([ "text-xl", "mb-4" ]) ])([ Halogen_HTML_Core.text("REPL for The Untyped \u03bb Calculus") ]), Halogen_HTML_Elements.section([ Halogen_HTML_Properties.classes([ "mb-8" ]) ])([ Halogen_HTML_Elements.h3([ Halogen_HTML_Properties.classes([ "text-lg", "mb-2" ]) ])([ Halogen_HTML_Core.text("Interpreter Options") ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "ml-2", "break-words" ]) ])([ Halogen_HTML_Core.text("Type `.help` in REPL for help.") ]) ]), Halogen_HTML_Elements.section([ Halogen_HTML_Properties.classes([ "mb-8" ]) ])([ Halogen_HTML_Elements.h3([ Halogen_HTML_Properties.classes([ "text-lg", "mb-2" ]) ])([ Halogen_HTML_Core.text("Syntax of \u03bb expression") ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "flex", "ml-8", "mt-2", "mb-4" ]) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "flex", "flex-col", "mr-2" ]) ])([ Halogen_HTML_Elements.div([  ])([ Halogen_HTML_Core.text("<term> ::=") ]), Halogen_HTML_Elements.div([  ])([ Halogen_HTML_Core.text("<term> ::=") ]), Halogen_HTML_Elements.div([  ])([ Halogen_HTML_Core.text("<term> ::=") ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "flex", "flex-col" ]) ])([ Halogen_HTML_Elements.div([  ])([ Halogen_HTML_Core.text("<variable>") ]), Halogen_HTML_Elements.div([  ])([ Halogen_HTML_Core.text("<lambda abstraction>") ]), Halogen_HTML_Elements.div([  ])([ Halogen_HTML_Core.text("<application>") ]) ]) ]), Halogen_HTML_Elements.section([ Halogen_HTML_Properties.classes([ "mb-4" ]) ])([ Halogen_HTML_Elements.h4([ Halogen_HTML_Properties.classes([ "mb-2" ]) ])([ Halogen_HTML_Core.text("1. Variables") ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "ml-8", "mt-2", "mb-4" ]) ])([ Halogen_HTML_Core.text("<variable> ::= <identifier>") ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "ml-4", "break-words" ]) ])([ Halogen_HTML_Elements.p([  ])([ Halogen_HTML_Core.text("<identifier> consists of alphabets, digits, ASCII characters except '\u03bb', and symbols '!', '@', '#', '$', '%', '^', '&', '*', '-', '_', '+', '|', '<', '>', '/', '?'.") ]) ]) ]), Halogen_HTML_Elements.section([ Halogen_HTML_Properties.classes([ "mb-4" ]) ])([ Halogen_HTML_Elements.h4([ Halogen_HTML_Properties.classes([ "mb-2" ]) ])([ Halogen_HTML_Core.text("2. Lambda Abstractions") ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "ml-8", "mt-2", "mb-4" ]) ])([ Halogen_HTML_Elements.div([  ])([ Halogen_HTML_Core.text("<lambda abstraction> ::= (<lambda><args>.<term>)") ]), Halogen_HTML_Elements.div([  ])([ Halogen_HTML_Core.text("<lambda> ::= \u03bb | \\") ]), Halogen_HTML_Elements.div([  ])([ Halogen_HTML_Core.text("<args> ::= <identifier> | <identifier> <args>") ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "ml-4", "break-words" ]) ])([ Halogen_HTML_Elements.p([  ])([ Halogen_HTML_Core.text("Lambda abstractions are right-associative.") ]), Halogen_HTML_Elements.p([  ])([ Halogen_HTML_Core.text("`(\u03bbx.\u03bby.M)` is equivalent to `(\u03bbx.(\u03bby.M))`.") ]), Halogen_HTML_Elements.p([  ])([ Halogen_HTML_Core.text("`(\u03bbx y.M)` is an abbreviation of `(\u03bbx.(\u03bby.M))`.") ]) ]) ]), Halogen_HTML_Elements.section([ Halogen_HTML_Properties.classes([ "mb-4" ]) ])([ Halogen_HTML_Elements.h4([ Halogen_HTML_Properties.classes([ "mb-2" ]) ])([ Halogen_HTML_Core.text("3. Applications") ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "ml-8", "mt-2", "mb-4" ]) ])([ Halogen_HTML_Elements.div([  ])([ Halogen_HTML_Core.text("<application> ::= (<term> <term>)") ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "ml-4", "break-words" ]) ])([ Halogen_HTML_Elements.p([  ])([ Halogen_HTML_Core.text("Applications are left-associative.") ]), Halogen_HTML_Elements.p([  ])([ Halogen_HTML_Core.text("`(M N L)` is equivalent to `((M N) L)`.") ]) ]) ]) ]) ]) ]) ]);
      };
      ...
      var handleAction = (function () {
          var copyListener = function (str) {
              return function (event) {
                  return function __do() {
                      var v = Control_Bind.bindFlipped(Effect.bindEffect)(Web_HTML_Window.document)(Web_HTML.window)();
                      var v1 = Control_Bind.bindFlipped(Data_Maybe.bindMaybe)(Web_Clipboard_ClipboardEvent.clipboardData)(Web_Clipboard_ClipboardEvent.fromEvent(event));
                      if (v1 instanceof Data_Maybe.Nothing) {
                          return Data_Unit.unit;
                      };
                      if (v1 instanceof Data_Maybe.Just) {
                          Web_HTML_Event_DataTransfer.setData(Data_MediaType_Common.textPlain)(str)(v1.value0)();
                          return Web_Event_Event.preventDefault(event)();
                      };
                      throw new Error("Failed pattern match at Main (line 214, column 7 - line 218, column 34): " + [ v1.constructor.name ]);
                  };
              };
          };
          var byId = function (id) {
              return function __do() {
                  var v = Control_Bind.bindFlipped(Effect.bindEffect)(Web_HTML_Window.document)(Web_HTML.window)();
                  return Web_DOM_NonElementParentNode.getElementById(getString(id))(Web_HTML_HTMLDocument.toNonElementParentNode(v))();
              };
          };
          var calculateTextAreaRows = Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(function __do() {
                  var v1 = byId(BehindTextAreaId.value)();
                  if (v1 instanceof Data_Maybe.Nothing) {
                      return Data_Maybe.Nothing.value;
                  };
                  if (v1 instanceof Data_Maybe.Just) {
                      var v2 = Web_DOM_Element.scrollHeight(v1.value0)();
                      var v3 = Control_Bind.bindFlipped(Effect.bindEffect)(Web_HTML_CSSStyleDeclaration.lineHeight)(Control_Bind.bindFlipped(Effect.bindEffect)(Web_HTML_CSSStyleDeclaration.getComputedStyle(v1.value0))(Web_HTML.window))();
                      var rows = Data_Int.round(v2 / v3);
                      var last = Data_String_CodeUnits.takeRight(1)(v.input);
                      var $84 = last === "" || (last === "\x0a" || last === "\x0d");
                      if ($84) {
                          return Data_Maybe.Just.create(rows + 1 | 0);
                      };
                      return new Data_Maybe.Just(rows);
                  };
                  throw new Error("Failed pattern match at Main (line 226, column 15 - line 241, column 20): " + [ v1.constructor.name ]);
              }))(function (v1) {
                  if (v1 instanceof Data_Maybe.Nothing) {
                  ...
                  if (v1 instanceof Data_Maybe.Just) {
                      return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                          ...
                          $88.textAreaRows = v1.value0;
                          return $88;
                      });
                  };
                  throw new Error("Failed pattern match at Main (line 242, column 7 - line 244, column 57): " + [ v1.constructor.name ]);
              });
          });
          var setHistory = function (historyIndex) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v) {
                  var v1 = Data_Array.index(v.repl.history)((Data_Array.length(v.repl.history) - historyIndex | 0) - 1 | 0);
                  if (v1 instanceof Data_Maybe.Nothing) {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
                  };
                  if (v1 instanceof Data_Maybe.Just) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                          ...
                          $95.input = v1.value0.input;
                          $95.inputMode = new SelectingHistory(historyIndex);
                          return $95;
                      }))(function () {
                          return calculateTextAreaRows;
                      });
                  };
                  throw new Error("Failed pattern match at Main (line 248, column 7 - line 253, column 32): " + [ v1.constructor.name ]);
              });
          };
          return function (v) {
              if (v instanceof Composition) {
                  return Data_Foldable.for_(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Foldable.foldableArray)(v.value0)(function (a) {
                      return handleAction(a);
                  });
              };
              if (v instanceof PreventDefault) {
                  return Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Web_Event_Event.preventDefault(v.value0));
              };
              if (v instanceof StopPropagation) {
                  return Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Web_Event_Event.stopPropagation(v.value0));
              };
              ...
              if (v instanceof Eval) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(handleAction(HiddenSelectOrCopyPopup.value))(function () {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                          ...
                          $111.inputMode = Evaluating.value;
                          return $111;
                      }))(function (v1) {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                              var $115 = {};
                              ...
                              $115.input = "";
                              $115.textAreaRows = 1;
                              $115.inputMode = Inputting.value;
                              $115.repl = UntypedLambda_REPL["eval"](v1.input)(v1.repl);
                              return $115;
                          }))(function () {
                              return handleAction(new FocusById(TextAreaId.value));
                          });
                      });
                  });
              };
              if (v instanceof KeyDown) {
                  ...
                  if (v1 === "Enter") {
                      return handleAction(new Composition([ PreventDefault.create(Web_UIEvent_KeyboardEvent.toEvent(v.value0)) ]));
                  };
                  if (v1 === "ArrowUp") {
                      return handleAction(new Composition([ PreventDefault.create(Web_UIEvent_KeyboardEvent.toEvent(v.value0)), HistoryUp.value ]));
                  };
                  if (v1 === "ArrowDown") {
                      return handleAction(new Composition([ PreventDefault.create(Web_UIEvent_KeyboardEvent.toEvent(v.value0)), HistoryDown.value ]));
                  };
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
              };
              if (v instanceof KeyUp) {
                  ...
                  if (v1 === "Enter") {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v2) {
                          var $124 = Data_String_Common["null"](Data_String_Common.trim(v2.input));
                          if ($124) {
                              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
                          };
                          return handleAction(new Composition([ PreventDefault.create(Web_UIEvent_KeyboardEvent.toEvent(v.value0)), Eval.value ]));
                      });
                  };
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
              };
              if (v instanceof HistoryUp) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(handleAction(HiddenSelectOrCopyPopup.value))(function () {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                          if (v1.inputMode instanceof Evaluating) {
                              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
                          };
                          ...
                          if (v1.inputMode instanceof SelectingHistory) {
                              return setHistory(v1.inputMode.value0 + 1 | 0);
                          };
                          throw new Error("Failed pattern match at Main (line 167, column 7 - line 170, column 61): " + [ v1.inputMode.constructor.name ]);
                      });
                  });
              };
              if (v instanceof HistoryDown) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(handleAction(HiddenSelectOrCopyPopup.value))(function () {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                          ...
                          throw new Error("Failed pattern match at Main (line 174, column 7 - line 178, column 61): " + [ v1.inputMode.constructor.name ]);
                      });
                  });
              };
              ...
              if (v instanceof FocusById) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(handleAction(HiddenSelectOrCopyPopup.value))(function () {
                      return Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(function __do() {
                          var v1 = byId(v.value0)();
                          var v2 = Control_Bind.bindFlipped(Data_Maybe.bindMaybe)(Web_HTML_HTMLElement.fromElement)(v1);
                          if (v2 instanceof Data_Maybe.Just) {
                              return Web_HTML_HTMLElement.focus(v2.value0)();
                          };
                          if (v2 instanceof Data_Maybe.Nothing) {
                              return Data_Unit.unit;
                          };
                          throw new Error("Failed pattern match at Main (line 187, column 13 - line 189, column 35): " + [ v2.constructor.name ]);
                      });
                  });
              };
              if (v instanceof DisplaySelectOrCopyPopup) {
                  return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                      var $147 = {};
                      for (var $148 in v1) {
                      ...
                      $147.popupState = new Display(v.value0, {
                          x: Web_UIEvent_MouseEvent.pageX(v.value1),
                          y: Web_UIEvent_MouseEvent.pageY(v.value1)
                      });
                      return $147;
                  });
              };
              if (v instanceof HiddenSelectOrCopyPopup) {
                  return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                      var $152 = {};
                      for (var $153 in v1) {
              ...
              if (v instanceof CopyToClipboard) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(handleAction(HiddenSelectOrCopyPopup.value))(function () {
                      return Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(function __do() {
                          var v1 = Control_Bind.bindFlipped(Effect.bindEffect)(Web_HTML_Window.document)(Web_HTML.window)();
                          var v2 = Web_Event_EventTarget.eventListener(copyListener(v.value0))();
                          Web_Event_EventTarget_Extra.addEventListenerOnce(Web_HTML_Event_EventTypes.copy)(v2)(false)(Web_HTML_HTMLDocument.toEventTarget(v1))();
                          var v3 = Web_HTML_HTMLDocument_ExecCommand.execCommand(Web_HTML_HTMLDocument_ExecCommand.copy)(v1)();
                          return Data_Unit.unit;
                      });
                  });
              };
              throw new Error("Failed pattern match at Main (line 130, column 18 - line 204, column 22): " + [ v.constructor.name ]);
          };
      })();
  ...
  exports["Inputting"] = Inputting;
  exports["SelectingHistory"] = SelectingHistory;
  ...
  exports["KeyDown"] = KeyDown;
  exports["KeyUp"] = KeyUp;
  exports["HistoryUp"] = HistoryUp;
  exports["HistoryDown"] = HistoryDown;
  exports["SwitchTab"] = SwitchTab;
  exports["FocusById"] = FocusById;
  exports["DisplaySelectOrCopyPopup"] = DisplaySelectOrCopyPopup;
  exports["HiddenSelectOrCopyPopup"] = HiddenSelectOrCopyPopup;
  exports["Select"] = Select;
  exports["CopyToClipboard"] = CopyToClipboard;
  exports["TextAreaId"] = TextAreaId;
  exports["BehindTextAreaId"] = BehindTextAreaId;
  exports["getString"] = getString;
  exports["Dummy"] = Dummy;
  exports["TextArea"] = TextArea;
  exports["WithPrompt"] = WithPrompt;
  exports["WithPromptAndLoading"] = WithPromptAndLoading;
  exports["WithoutPrompt"] = WithoutPrompt;
  exports["main"] = main;
})(PS);
PS["Main"].main();