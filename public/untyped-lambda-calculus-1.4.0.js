...
(function($PS) {
  ...
  var $$eval = function (env) {
      return function (input) {
          var v = Text_Parsing_Parser.runParser(input)(define);
          if (v instanceof Data_Either.Right) {
              var value = UntypedLambda_Core.callByValue(UntypedLambda_Core.withEnvironment(env)(v.value0.value1));
              return Control_Applicative.pure(Data_Either.applicativeEither)(Data_Tuple.Tuple.create(value)(Data_Array.cons(new Data_Tuple.Tuple(v.value0.value0, value))(env)));
          };
          if (v instanceof Data_Either.Left) {
              var v1 = Text_Parsing_Parser.runParser(input)(UntypedLambda_Parser.expression);
              if (v1 instanceof Data_Either.Right) {
                  return Control_Applicative.pure(Data_Either.applicativeEither)(new Data_Tuple.Tuple(UntypedLambda_Core.callByValue(UntypedLambda_Core.withEnvironment(env)(v1.value0)), env));
              };
              if (v1 instanceof Data_Either.Left) {
                  var message = Text_Parsing_Parser.parseErrorMessage(v1.value0);
                  var inputLines = Data_Array.concatMap(Data_String_Common.split("\x0d"))(Data_String_Common.split("\x0a")(input));
                  var v2 = Text_Parsing_Parser.parseErrorPosition(v1.value0);
                  var v3 = Data_Array.index(inputLines)(v2.line - 1 | 0);
                  if (v3 instanceof Data_Maybe.Just) {
                      return Data_Either.Left.create(ParseError.create(message + (" near '" + (Data_String_CodePoints.take(v2.column)(v3.value0) + "'"))));
                  };
                  if (v3 instanceof Data_Maybe.Nothing) {
                      return Data_Either.Left.create(ParseError.create(message));
                  };
                  throw new Error("Failed pattern match at UntypedLambda.Repl (line 54, column 9 - line 56, column 49): " + [ v3.constructor.name ]);
              };
              throw new Error("Failed pattern match at UntypedLambda.Repl (line 41, column 13 - line 56, column 49): " + [ v1.constructor.name ]);
          };
          throw new Error("Failed pattern match at UntypedLambda.Repl (line 35, column 18 - line 56, column 49): " + [ v.constructor.name ]);
      };
  };
  exports["eval"] = $$eval;
})(PS);
...
(function($PS) {
  ...
  var getString = function (v) {
      ...
      throw new Error("Failed pattern match at Editor (line 57, column 1 - line 57, column 26): " + [ v.constructor.name ]);
  };
  var main = (function () {
      var render = function (state) {
          return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.header([ Halogen_HTML_Properties.classes([ "flex", "justify-between", "my-4" ]) ])([ Halogen_HTML_Elements.h1([ Halogen_HTML_Properties.classes([ "mx-6", "text-3xl" ]) ])([ Halogen_HTML_Elements.span([ Halogen_HTML_Properties.classes([ "inline-block", "w-12", "h-12", "rounded-full", "bg-indigo-800", "align-middle", "text-center", "font-black" ]) ])([ Halogen_HTML_Elements.span([ Halogen_HTML_Properties.classes([ "inline-block", "pt-1" ]) ])([ Halogen_HTML_Core.text("\u03bb") ]) ]) ]), Halogen_HTML_Elements.nav([ Halogen_HTML_Properties.classes([ "mx-2" ]) ])([ Halogen_HTML_Elements.ul([ Halogen_HTML_Properties.classes([ "flex", "justify-end" ]) ])([ Halogen_HTML_Elements.li_([ Halogen_HTML_Elements.a([ Halogen_HTML_Properties.target("_blank"), Halogen_HTML_Properties.href("https://github.com/utatatata/untyped-lambda-calculus") ])([ Halogen_HTML_Core.text("GitHub") ]) ]) ]) ]) ]), Halogen_HTML_Elements.main([ Halogen_HTML_Properties.classes([ "mx-4", "w-auto" ]) ])([ Halogen_HTML_Elements.section_([ Halogen_HTML_Elements.h2_([ Halogen_HTML_Core.text("REPL") ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "flex", "flex-col-reverse" ]) ])(Data_Functor.map(Data_Functor.functorArray)(function (v) {
              return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "flex" ]) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "flex", "justify-env" ]) ])([ Halogen_HTML_Elements.span([ Halogen_HTML_Properties.classes([ "mr-1" ]) ])([ Halogen_HTML_Core.text(">") ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "w-full", "bg-gray-800" ]) ])([ Halogen_HTML_Elements.span([ Halogen_HTML_Properties.classes([ "break-all", "whitespace-pre-wrap" ]) ])([ Halogen_HTML_Core.text(v.input) ]) ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "break-all" ]) ])([ Halogen_HTML_Core.text(v.output) ]) ]);
          })(state.history)), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "flex" ]) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "flex", "justify-end" ]) ])([ Halogen_HTML_Elements.span([ Halogen_HTML_Properties.classes([ "mr-1" ]) ])([ Halogen_HTML_Core.text(">") ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "flex", "relative", "w-full" ]) ])([ Halogen_HTML_Elements.textarea([ Halogen_HTML_Properties.id_(getString(TextAreaId.value)), Halogen_HTML_Properties.classes([ "w-full", "apperance-none", "focus:outline-none", "bg-gray-800", "resize-none", "overflow-y-hidden", "z-10" ]), Halogen_HTML_Properties.rows(state.textAreaRows), Halogen_HTML_Properties.autofocus(true), Halogen_HTML_Properties.value(state.input), Halogen_HTML_Events.onKeyDown(function ($105) {
              return Data_Maybe.Just.create(KeyDown.create($105));
          }), Halogen_HTML_Events.onKeyUp(function ($106) {
              return Data_Maybe.Just.create(KeyUp.create($106));
          }), Halogen_HTML_Events.onValueInput(function ($107) {
              return Data_Maybe.Just.create(Input.create($107));
          ...
          return function (v) {
                      ...
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                          ...
                          if (v2 instanceof Data_Either.Right) {
                              return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                                  ...
                                  $43.history = Data_Array.cons({
                                      input: v1.input,
                                      output: UntypedLambda.display(v2.value0.value0)
                                  })(v1.history);
                                  $43.env = v2.value0.value1;
                                  return $43;
                              });
                          };
                          ...
                          throw new Error("Failed pattern match at Editor (line 95, column 7 - line 105, column 80): " + [ v2.constructor.name ]);
                      })())(function () {
              ...
              if (v instanceof CalculateTextAreaRows) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(function __do() {
                      ...
                      throw new Error("Failed pattern match at Editor (line 121, column 15 - line 136, column 20): " + [ v1.constructor.name ]);
                  }))(function (v1) {
                      if (v1 instanceof Data_Maybe.Nothing) {
                          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
                      };
                      ...
                      throw new Error("Failed pattern match at Editor (line 137, column 7 - line 139, column 57): " + [ v1.constructor.name ]);
                  });
              };
              if (v instanceof HistoryUp) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                      var n = (function () {
                          ...
                          throw new Error("Failed pattern match at Editor (line 143, column 15 - line 145, column 52): " + [ v1.inputMode.constructor.name ]);
                      })();
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v2) {
                          ...
                          throw new Error("Failed pattern match at Editor (line 149, column 13 - line 154, column 59): " + [ v3.constructor.name ]);
                      });
                  });
              };
                          ...
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v2) {
                              ...
                              if (v3 instanceof Data_Maybe.Just) {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v4) {
                                      ...
                                      $95.input = v3.value0.input;
                                      $95.inputMode = SelectingHistory.create(v1.inputMode.value0 - 1 | 0);
                                      return $95;
                                  }))(function () {
                                      return handleAction(new CalculateTextAreaRows(v3.value0.input));
                                  });
                              };
                              throw new Error("Failed pattern match at Editor (line 163, column 11 - line 167, column 57): " + [ v3.constructor.name ]);
                          });
                      };
                      throw new Error("Failed pattern match at Editor (line 158, column 7 - line 167, column 57): " + [ v1.inputMode.constructor.name ]);
                  });
              };
              throw new Error("Failed pattern match at Editor (line 85, column 18 - line 167, column 57): " + [ v.constructor.name ]);
          };
      })();
